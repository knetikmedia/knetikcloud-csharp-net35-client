...
namespace IO.Swagger.Test
{
    ...
    public class UsersApiTests
    {
        ...
        public void GetUsersTest()
        {
            ...
            //int? page = null;
            //string order = null;
            //var response = instance.GetUsers(filterDisplayname, filterEmail, filterFirstname, filterFullname, filterLastname, filterUsername, filterTag, filterGroup, filterRole, filterSearch, size, page, order);
