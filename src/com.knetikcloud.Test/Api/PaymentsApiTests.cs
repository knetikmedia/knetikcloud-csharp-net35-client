...
namespace com.knetikcloud.Test
{
    ...
    public class PaymentsApiTests
    {
        ...
        public void GetPaymentMethodTypeTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? id = null;
            //var response = instance.GetPaymentMethodType(id);
            //Assert.IsInstanceOf<PaymentMethodTypeResource> (response, "response is PaymentMethodTypeResource");
        }
        
        /// <summary>
        /// Test GetPaymentMethodTypes
        /// </summary>
        [Test]
        public void GetPaymentMethodTypesTest()
        {
            ...
            //int? page = null;
            //string order = null;
            //var response = instance.GetPaymentMethodTypes(filterName, size, page, order);
            //Assert.IsInstanceOf<PageResourcePaymentMethodTypeResource> (response, "response is PageResourcePaymentMethodTypeResource");
        }
        ...
        public void GetPaymentMethodsTest()
        {
            ...
            //int? filterPaymentMethodTypeId = null;
            //string filterPaymentMethodTypeName = null;
            //int? size = null;
            //int? page = null;
            //string order = null;
            //var response = instance.GetPaymentMethods(userId, filterName, filterPaymentType, filterPaymentMethodTypeId, filterPaymentMethodTypeName, size, page, order);
