...
namespace com.knetikcloud.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://jsapi-integration.us-east-1.elasticbeanstalk.com");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://jsapi-integration.us-east-1.elasticbeanstalk.com).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? com.knetikcloud.Client.Configuration.Default;
