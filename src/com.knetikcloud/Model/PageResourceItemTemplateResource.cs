...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceItemTemplateResource :  IEquatable<PageResourceItemTemplateResource>
    {
        ...
        {
            return this.Equals(input as PageResourceItemTemplateResource);
        }

        /// <summary>
        /// Returns true if PageResourceItemTemplateResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceItemTemplateResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceItemTemplateResource input)
        {
            if (input == null)
                return false;
