...
namespace com.knetikcloud.Model
{
    ...
    public partial class BreGlobalScopeDefinition :  IEquatable<BreGlobalScopeDefinition>
    {
        ...
        {
            return this.Equals(input as BreGlobalScopeDefinition);
        }

        /// <summary>
        /// Returns true if BreGlobalScopeDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of BreGlobalScopeDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BreGlobalScopeDefinition input)
        {
            if (input == null)
                return false;
