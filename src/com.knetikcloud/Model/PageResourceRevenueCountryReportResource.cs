...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceRevenueCountryReportResource :  IEquatable<PageResourceRevenueCountryReportResource>
    {
        ...
        {
            return this.Equals(input as PageResourceRevenueCountryReportResource);
        }

        /// <summary>
        /// Returns true if PageResourceRevenueCountryReportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceRevenueCountryReportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceRevenueCountryReportResource input)
        {
            if (input == null)
                return false;
