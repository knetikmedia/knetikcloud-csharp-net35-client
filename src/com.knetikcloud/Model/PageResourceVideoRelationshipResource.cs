...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceVideoRelationshipResource :  IEquatable<PageResourceVideoRelationshipResource>
    {
        ...
        {
            return this.Equals(input as PageResourceVideoRelationshipResource);
        }

        /// <summary>
        /// Returns true if PageResourceVideoRelationshipResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceVideoRelationshipResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceVideoRelationshipResource input)
        {
            if (input == null)
                return false;
