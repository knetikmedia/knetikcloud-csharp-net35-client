...
namespace com.knetikcloud.Model
{
    ...
    public partial class PredicateResource :  IEquatable<PredicateResource>
    {
        ...
        public PredicateResource(List<ExpressionResource> Args = default(List<ExpressionResource>), string Definition = default(string), string Op = default(string), string ReturnType = default(string), List<OperationDefinitionResource> SupportedOperators = default(List<OperationDefinitionResource>), string Type = default(string))
        {
