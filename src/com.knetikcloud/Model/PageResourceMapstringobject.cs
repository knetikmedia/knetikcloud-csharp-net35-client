...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceMapstringobject :  IEquatable<PageResourceMapstringobject>
    {
        ...
        {
            return this.Equals(input as PageResourceMapstringobject);
        }

        /// <summary>
        /// Returns true if PageResourceMapstringobject instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceMapstringobject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceMapstringobject input)
        {
            if (input == null)
                return false;
