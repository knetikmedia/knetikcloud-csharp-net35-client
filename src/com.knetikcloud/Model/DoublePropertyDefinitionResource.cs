...
namespace com.knetikcloud.Model
{
    ...
    public partial class DoublePropertyDefinitionResource : PropertyDefinitionResource,  IEquatable<DoublePropertyDefinitionResource>
    {
        ...
        protected DoublePropertyDefinitionResource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DoublePropertyDefinitionResource" /> class.
        /// </summary>
        ...
        public DoublePropertyDefinitionResource(string Description = default(string), PropertyFieldListResource FieldList = default(PropertyFieldListResource), string FriendlyName = default(string), string Name = default(string), string OptionLabelPath = default(string), string OptionValuePath = default(string), string OptionsUrl = default(string), bool? Required = default(bool?), string Type = default(string), double? Max = default(double?), double? Min = default(double?))
        {
        ...
        {
            return this.Equals(input as DoublePropertyDefinitionResource);
        }

        /// <summary>
        /// Returns true if DoublePropertyDefinitionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of DoublePropertyDefinitionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DoublePropertyDefinitionResource input)
        {
            if (input == null)
                return false;
