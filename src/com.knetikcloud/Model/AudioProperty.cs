...
namespace com.knetikcloud.Model
{
    ...
    public partial class AudioProperty : FileProperty,  IEquatable<AudioProperty>
    {
        ...
        {
            return this.Equals(input as AudioProperty);
        }

        /// <summary>
        /// Returns true if AudioProperty instances are equal
        /// </summary>
        /// <param name="input">Instance of AudioProperty to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AudioProperty input)
        {
            if (input == null)
                return false;
