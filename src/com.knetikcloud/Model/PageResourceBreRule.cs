...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceBreRule :  IEquatable<PageResourceBreRule>
    {
        ...
        {
            return this.Equals(input as PageResourceBreRule);
        }

        /// <summary>
        /// Returns true if PageResourceBreRule instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceBreRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceBreRule input)
        {
            if (input == null)
                return false;
