...
namespace com.knetikcloud.Model
{
    ...
    public partial class NewCustomerEvent : BroadcastableEvent,  IEquatable<NewCustomerEvent>
    {
        ...
        public NewCustomerEvent(string _Client = default(string), string Customer = default(string), bool? DoNotBroadcast = default(bool?), string Section = default(string), Object Source = default(Object), string Specifics = default(string), bool? Synchronous = default(bool?), long? Timestamp = default(long?), string Type = default(string), CustomerConfig CustomerConfig = default(CustomerConfig))
        {
        ...
        {
            return this.Equals(input as NewCustomerEvent);
        }

        /// <summary>
        /// Returns true if NewCustomerEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of NewCustomerEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewCustomerEvent input)
        {
            if (input == null)
                return false;
