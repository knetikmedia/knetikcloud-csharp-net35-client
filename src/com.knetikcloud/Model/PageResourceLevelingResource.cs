...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceLevelingResource :  IEquatable<PageResourceLevelingResource>
    {
        ...
        {
            return this.Equals(input as PageResourceLevelingResource);
        }

        /// <summary>
        /// Returns true if PageResourceLevelingResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceLevelingResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceLevelingResource input)
        {
            if (input == null)
                return false;
