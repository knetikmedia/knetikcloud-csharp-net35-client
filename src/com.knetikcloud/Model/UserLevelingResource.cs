...
namespace com.knetikcloud.Model
{
    ...
    public partial class UserLevelingResource :  IEquatable<UserLevelingResource>
    {
        ...
        {
            return this.Equals(input as UserLevelingResource);
        }

        /// <summary>
        /// Returns true if UserLevelingResource instances are equal
        /// </summary>
        /// <param name="input">Instance of UserLevelingResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserLevelingResource input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.LastTierName == input.LastTierName ||
                    (this.LastTierName != null &&
                    this.LastTierName.Equals(input.LastTierName))
                ) && 
                (
                    this.LastTierProgress == input.LastTierProgress ||
                    (this.LastTierProgress != null &&
                    this.LastTierProgress.Equals(input.LastTierProgress))
                ) && 
                (
                ...
                (
                    this.NextTierProgress == input.NextTierProgress ||
                    (this.NextTierProgress != null &&
                    this.NextTierProgress.Equals(input.NextTierProgress))
                ) && 
                (
                ...
                (
                    this.TierNames == input.TierNames ||
                    (this.TierNames != null &&
                    this.TierNames.SequenceEqual(input.TierNames))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LastTierName != null)
                    hashCode = hashCode * 59 + this.LastTierName.GetHashCode();
                if (this.LastTierProgress != null)
                    hashCode = hashCode * 59 + this.LastTierProgress.GetHashCode();
                ...
                if (this.NextTierProgress != null)
                    hashCode = hashCode * 59 + this.NextTierProgress.GetHashCode();
                if (this.Progress != null)
                    hashCode = hashCode * 59 + this.Progress.GetHashCode();
                if (this.TierNames != null)
                    hashCode = hashCode * 59 + this.TierNames.GetHashCode();
                if (this.UserId != null)
