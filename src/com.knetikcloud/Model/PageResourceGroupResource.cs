...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceGroupResource :  IEquatable<PageResourceGroupResource>
    {
        ...
        {
            return this.Equals(input as PageResourceGroupResource);
        }

        /// <summary>
        /// Returns true if PageResourceGroupResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceGroupResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceGroupResource input)
        {
            if (input == null)
                return false;
