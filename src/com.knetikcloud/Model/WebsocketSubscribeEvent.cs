...
namespace com.knetikcloud.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebsocketSubscribeEvent : BroadcastableEvent,  IEquatable<WebsocketSubscribeEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebsocketSubscribeEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebsocketSubscribeEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebsocketSubscribeEvent" /> class.
        /// </summary>
        ...
        /// <param name="UserResource">UserResource.</param>
        public WebsocketSubscribeEvent(string _Client = default(string), string Customer = default(string), bool? DoNotBroadcast = default(bool?), string Section = default(string), Object Source = default(Object), string Specifics = default(string), bool? Synchronous = default(bool?), long? Timestamp = default(long?), string Type = default(string), Topic Topic = default(Topic), UserResource UserResource = default(UserResource))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for WebsocketSubscribeEvent and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        {
            return this.Equals(input as WebsocketSubscribeEvent);
        }

        /// <summary>
        /// Returns true if WebsocketSubscribeEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of WebsocketSubscribeEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebsocketSubscribeEvent input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.UserResource == input.UserResource ||
                    (this.UserResource != null &&
                    this.UserResource.Equals(input.UserResource))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UserResource != null)
                    hashCode = hashCode * 59 + this.UserResource.GetHashCode();
                return hashCode;
            }
        }
