...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceBreGlobalResource :  IEquatable<PageResourceBreGlobalResource>
    {
        ...
        {
            return this.Equals(input as PageResourceBreGlobalResource);
        }

        /// <summary>
        /// Returns true if PageResourceBreGlobalResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceBreGlobalResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceBreGlobalResource input)
        {
            if (input == null)
                return false;
