...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceLocationLogResource :  IEquatable<PageResourceLocationLogResource>
    {
        ...
        {
            return this.Equals(input as PageResourceLocationLogResource);
        }

        /// <summary>
        /// Returns true if PageResourceLocationLogResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceLocationLogResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceLocationLogResource input)
        {
            if (input == null)
                return false;
