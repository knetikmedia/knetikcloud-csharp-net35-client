...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceAchievementDefinitionResource :  IEquatable<PageResourceAchievementDefinitionResource>
    {
        ...
        {
            return this.Equals(input as PageResourceAchievementDefinitionResource);
        }

        /// <summary>
        /// Returns true if PageResourceAchievementDefinitionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceAchievementDefinitionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceAchievementDefinitionResource input)
        {
            if (input == null)
                return false;
