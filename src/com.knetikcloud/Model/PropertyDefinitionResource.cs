...
namespace com.knetikcloud.Model
{
    ...
    public partial class PropertyDefinitionResource :  IEquatable<PropertyDefinitionResource>
    {
        ...
        {
            return this.Equals(input as PropertyDefinitionResource);
        }

        /// <summary>
        /// Returns true if PropertyDefinitionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertyDefinitionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertyDefinitionResource input)
        {
            if (input == null)
                return false;
