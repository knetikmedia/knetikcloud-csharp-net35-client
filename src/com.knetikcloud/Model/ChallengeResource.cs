...
namespace com.knetikcloud.Model
{
    ...
    public partial class ChallengeResource :  IEquatable<ChallengeResource>
    {
        ...
        {
            return this.Equals(input as ChallengeResource);
        }

        /// <summary>
        /// Returns true if ChallengeResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ChallengeResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChallengeResource input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CopyOf == input.CopyOf ||
                    (this.CopyOf != null &&
                    this.CopyOf.Equals(input.CopyOf))
                ) && 
                (
                ...
                (
                    this.NextEventDate == input.NextEventDate ||
                    (this.NextEventDate != null &&
                    this.NextEventDate.Equals(input.NextEventDate))
                ) && 
                (
                    this.RewardLagMinutes == input.RewardLagMinutes ||
                    (this.RewardLagMinutes != null &&
                    this.RewardLagMinutes.Equals(input.RewardLagMinutes))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CopyOf != null)
                    hashCode = hashCode * 59 + this.CopyOf.GetHashCode();
                ...
                if (this.NextEventDate != null)
                    hashCode = hashCode * 59 + this.NextEventDate.GetHashCode();
                if (this.RewardLagMinutes != null)
                    hashCode = hashCode * 59 + this.RewardLagMinutes.GetHashCode();
