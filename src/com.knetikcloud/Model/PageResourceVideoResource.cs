...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceVideoResource :  IEquatable<PageResourceVideoResource>
    {
        ...
        {
            return this.Equals(input as PageResourceVideoResource);
        }

        /// <summary>
        /// Returns true if PageResourceVideoResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceVideoResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceVideoResource input)
        {
            if (input == null)
                return false;
