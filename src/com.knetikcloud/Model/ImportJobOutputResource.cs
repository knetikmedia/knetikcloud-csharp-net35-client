...
namespace com.knetikcloud.Model
{
    ...
    public partial class ImportJobOutputResource :  IEquatable<ImportJobOutputResource>
    {
        ...
        {
            return this.Equals(input as ImportJobOutputResource);
        }

        /// <summary>
        /// Returns true if ImportJobOutputResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ImportJobOutputResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportJobOutputResource input)
        {
            if (input == null)
                return false;
