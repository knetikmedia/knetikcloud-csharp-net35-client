...
namespace com.knetikcloud.Model
{
    ...
    public partial class PriceOverridable : Behavior,  IEquatable<PriceOverridable>
    {
        ...
        public PriceOverridable(string Description = default(string), string TypeHint = default(string), decimal? MaxPrice = default(decimal?), decimal? MinPrice = default(decimal?))
        {
