...
namespace com.knetikcloud.Model
{
    ...
    public partial class LookupTypeResource :  IEquatable<LookupTypeResource>
    {
        ...
        {
            return this.Equals(input as LookupTypeResource);
        }

        /// <summary>
        /// Returns true if LookupTypeResource instances are equal
        /// </summary>
        /// <param name="input">Instance of LookupTypeResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LookupTypeResource input)
        {
            if (input == null)
                return false;
