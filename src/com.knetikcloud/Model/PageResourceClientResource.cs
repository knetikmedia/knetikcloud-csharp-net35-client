...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceClientResource :  IEquatable<PageResourceClientResource>
    {
        ...
        {
            return this.Equals(input as PageResourceClientResource);
        }

        /// <summary>
        /// Returns true if PageResourceClientResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceClientResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceClientResource input)
        {
            if (input == null)
                return false;
