...
namespace com.knetikcloud.Model
{
    ...
    public partial class AudioPropertyDefinitionResource : PropertyDefinitionResource,  IEquatable<AudioPropertyDefinitionResource>
    {
        ...
        protected AudioPropertyDefinitionResource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AudioPropertyDefinitionResource" /> class.
        /// </summary>
        ...
        public AudioPropertyDefinitionResource(string Description = default(string), PropertyFieldListResource FieldList = default(PropertyFieldListResource), string FriendlyName = default(string), string Name = default(string), string OptionLabelPath = default(string), string OptionValuePath = default(string), string OptionsUrl = default(string), bool? Required = default(bool?), string Type = default(string), string FileType = default(string), int? MaxLength = default(int?), int? MinLength = default(int?))
        {
        ...
        {
            return this.Equals(input as AudioPropertyDefinitionResource);
        }

        /// <summary>
        /// Returns true if AudioPropertyDefinitionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of AudioPropertyDefinitionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AudioPropertyDefinitionResource input)
        {
            if (input == null)
                return false;
