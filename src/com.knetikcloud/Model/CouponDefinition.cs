...
namespace com.knetikcloud.Model
{
    ...
    public partial class CouponDefinition :  IEquatable<CouponDefinition>
    {
        ...
        public CouponDefinition(string Code = default(string), string Description = default(string), DiscountTypeEnum? DiscountType = default(DiscountTypeEnum?), bool? Exclusive = default(bool?), decimal? MaxDiscount = default(decimal?), int? MaxQuantity = default(int?), decimal? MinCartTotal = default(decimal?), string Name = default(string), bool? SelfExclusive = default(bool?), int? TargetItemId = default(int?), TypeEnum? Type = default(TypeEnum?), string UniqueKey = default(string), List<string> ValidForTags = default(List<string>), decimal? Value = default(decimal?), int? VendorId = default(int?))
        {
        ...
        {
            return this.Equals(input as CouponDefinition);
        }

        /// <summary>
        /// Returns true if CouponDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponDefinition input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MinCartTotal == input.MinCartTotal ||
                    (this.MinCartTotal != null &&
                    this.MinCartTotal.Equals(input.MinCartTotal))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MinCartTotal != null)
                    hashCode = hashCode * 59 + this.MinCartTotal.GetHashCode();
                if (this.Name != null)
