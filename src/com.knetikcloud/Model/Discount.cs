...
namespace com.knetikcloud.Model
{
    ...
    public partial class Discount :  IEquatable<Discount>
    {
        ...
        public Discount(string Description = default(string), string Name = default(string), string Sku = default(string), string UniqueKey = default(string), decimal? Value = default(decimal?))
        {
