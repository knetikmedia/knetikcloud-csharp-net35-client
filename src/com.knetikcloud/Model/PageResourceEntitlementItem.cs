...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceEntitlementItem :  IEquatable<PageResourceEntitlementItem>
    {
        ...
        {
            return this.Equals(input as PageResourceEntitlementItem);
        }

        /// <summary>
        /// Returns true if PageResourceEntitlementItem instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceEntitlementItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceEntitlementItem input)
        {
            if (input == null)
                return false;
