...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceRevenueProductReportResource :  IEquatable<PageResourceRevenueProductReportResource>
    {
        ...
        {
            return this.Equals(input as PageResourceRevenueProductReportResource);
        }

        /// <summary>
        /// Returns true if PageResourceRevenueProductReportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceRevenueProductReportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceRevenueProductReportResource input)
        {
            if (input == null)
                return false;
