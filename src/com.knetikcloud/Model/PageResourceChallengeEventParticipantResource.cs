...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceChallengeEventParticipantResource :  IEquatable<PageResourceChallengeEventParticipantResource>
    {
        ...
        {
            return this.Equals(input as PageResourceChallengeEventParticipantResource);
        }

        /// <summary>
        /// Returns true if PageResourceChallengeEventParticipantResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceChallengeEventParticipantResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceChallengeEventParticipantResource input)
        {
            if (input == null)
                return false;
