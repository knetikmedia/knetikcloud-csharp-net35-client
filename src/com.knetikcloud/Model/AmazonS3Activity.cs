...
namespace com.knetikcloud.Model
{
    ...
    public partial class AmazonS3Activity :  IEquatable<AmazonS3Activity>
    {
        ...
        /// <param name="CdnUrl">URL for accessing the resource via CDN if configured (will default to the main url if not).</param>
        ...
        /// <param name="Url">URL for posting and later accessing the S3 resource.</param>
