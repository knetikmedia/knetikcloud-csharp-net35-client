...
namespace com.knetikcloud.Model
{
    ...
    public partial class SearchReferenceMapping :  IEquatable<SearchReferenceMapping>
    {
        ...
        {
            return this.Equals(input as SearchReferenceMapping);
        }

        /// <summary>
        /// Returns true if SearchReferenceMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchReferenceMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchReferenceMapping input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RefIdField == input.RefIdField ||
                    (this.RefIdField != null &&
                    this.RefIdField.Equals(input.RefIdField))
                ) && 
                (
                ...
                (
                    this.SourceFieldToDestinationField == input.SourceFieldToDestinationField ||
                    (this.SourceFieldToDestinationField != null &&
                    this.SourceFieldToDestinationField.SequenceEqual(input.SourceFieldToDestinationField))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RefIdField != null)
                    hashCode = hashCode * 59 + this.RefIdField.GetHashCode();
                if (this.RefType != null)
                    hashCode = hashCode * 59 + this.RefType.GetHashCode();
                if (this.SourceFieldToDestinationField != null)
                    hashCode = hashCode * 59 + this.SourceFieldToDestinationField.GetHashCode();
                if (this.Type != null)
