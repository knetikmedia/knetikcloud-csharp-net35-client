...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceUserRelationshipResource :  IEquatable<PageResourceUserRelationshipResource>
    {
        ...
        {
            return this.Equals(input as PageResourceUserRelationshipResource);
        }

        /// <summary>
        /// Returns true if PageResourceUserRelationshipResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceUserRelationshipResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceUserRelationshipResource input)
        {
            if (input == null)
                return false;
