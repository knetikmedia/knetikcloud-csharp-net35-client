...
namespace com.knetikcloud.Model
{
    ...
    public partial class BreTriggerResource :  IEquatable<BreTriggerResource>
    {
        ...
        {
            return this.Equals(input as BreTriggerResource);
        }

        /// <summary>
        /// Returns true if BreTriggerResource instances are equal
        /// </summary>
        /// <param name="input">Instance of BreTriggerResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BreTriggerResource input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SystemTrigger == input.SystemTrigger ||
                    (this.SystemTrigger != null &&
                    this.SystemTrigger.Equals(input.SystemTrigger))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SystemTrigger != null)
                    hashCode = hashCode * 59 + this.SystemTrigger.GetHashCode();
                if (this.Tags != null)
