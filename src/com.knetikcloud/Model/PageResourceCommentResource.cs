...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceCommentResource :  IEquatable<PageResourceCommentResource>
    {
        ...
        {
            return this.Equals(input as PageResourceCommentResource);
        }

        /// <summary>
        /// Returns true if PageResourceCommentResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceCommentResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceCommentResource input)
        {
            if (input == null)
                return false;
