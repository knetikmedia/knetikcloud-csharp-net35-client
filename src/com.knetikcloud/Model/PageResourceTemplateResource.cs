...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceTemplateResource :  IEquatable<PageResourceTemplateResource>
    {
        ...
        {
            return this.Equals(input as PageResourceTemplateResource);
        }

        /// <summary>
        /// Returns true if PageResourceTemplateResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceTemplateResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceTemplateResource input)
        {
            if (input == null)
                return false;
