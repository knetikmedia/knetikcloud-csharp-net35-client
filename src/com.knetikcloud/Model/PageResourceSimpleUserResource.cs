...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceSimpleUserResource :  IEquatable<PageResourceSimpleUserResource>
    {
        ...
        {
            return this.Equals(input as PageResourceSimpleUserResource);
        }

        /// <summary>
        /// Returns true if PageResourceSimpleUserResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceSimpleUserResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceSimpleUserResource input)
        {
            if (input == null)
                return false;
