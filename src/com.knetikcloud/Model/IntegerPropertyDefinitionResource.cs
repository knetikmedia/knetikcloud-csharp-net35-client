...
namespace com.knetikcloud.Model
{
    ...
    public partial class IntegerPropertyDefinitionResource : PropertyDefinitionResource,  IEquatable<IntegerPropertyDefinitionResource>
    {
        ...
        protected IntegerPropertyDefinitionResource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegerPropertyDefinitionResource" /> class.
        /// </summary>
        ...
        public IntegerPropertyDefinitionResource(string Description = default(string), PropertyFieldListResource FieldList = default(PropertyFieldListResource), string FriendlyName = default(string), string Name = default(string), string OptionLabelPath = default(string), string OptionValuePath = default(string), string OptionsUrl = default(string), bool? Required = default(bool?), string Type = default(string), int? Max = default(int?), int? Min = default(int?))
        {
        ...
        {
            return this.Equals(input as IntegerPropertyDefinitionResource);
        }

        /// <summary>
        /// Returns true if IntegerPropertyDefinitionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of IntegerPropertyDefinitionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntegerPropertyDefinitionResource input)
        {
            if (input == null)
                return false;
