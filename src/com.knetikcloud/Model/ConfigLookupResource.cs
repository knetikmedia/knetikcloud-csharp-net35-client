...
namespace com.knetikcloud.Model
{
    ...
    public partial class ConfigLookupResource :  IEquatable<ConfigLookupResource>
    {
        ...
        public ConfigLookupResource(string Definition = default(string), ExpressionResource LookupKey = default(ExpressionResource), string RequiredKeyType = default(string), string Type = default(string), string ValueType = default(string))
        {
        ...
        {
            return this.Equals(input as ConfigLookupResource);
        }

        /// <summary>
        /// Returns true if ConfigLookupResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigLookupResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigLookupResource input)
        {
            if (input == null)
                return false;
