...
namespace com.knetikcloud.Model
{
    ...
    public partial class ShippingItem : StoreItem,  IEquatable<ShippingItem>
    {
        ...
        {
            return this.Equals(input as ShippingItem);
        }

        /// <summary>
        /// Returns true if ShippingItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ShippingItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShippingItem input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MaxTierTotal == input.MaxTierTotal ||
                    (this.MaxTierTotal != null &&
                    this.MaxTierTotal.Equals(input.MaxTierTotal))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MaxTierTotal != null)
                    hashCode = hashCode * 59 + this.MaxTierTotal.GetHashCode();
