...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceRewardSetResource :  IEquatable<PageResourceRewardSetResource>
    {
        ...
        {
            return this.Equals(input as PageResourceRewardSetResource);
        }

        /// <summary>
        /// Returns true if PageResourceRewardSetResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceRewardSetResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceRewardSetResource input)
        {
            if (input == null)
                return false;
