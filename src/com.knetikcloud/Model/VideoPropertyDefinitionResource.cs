...
namespace com.knetikcloud.Model
{
    ...
    public partial class VideoPropertyDefinitionResource : PropertyDefinitionResource,  IEquatable<VideoPropertyDefinitionResource>
    {
        ...
        protected VideoPropertyDefinitionResource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VideoPropertyDefinitionResource" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as VideoPropertyDefinitionResource);
        }

        /// <summary>
        /// Returns true if VideoPropertyDefinitionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of VideoPropertyDefinitionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VideoPropertyDefinitionResource input)
        {
            if (input == null)
                return false;
