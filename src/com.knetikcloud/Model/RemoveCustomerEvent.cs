...
namespace com.knetikcloud.Model
{
    ...
    public partial class RemoveCustomerEvent : BroadcastableEvent,  IEquatable<RemoveCustomerEvent>
    {
        ...
        public RemoveCustomerEvent(string _Client = default(string), string Customer = default(string), bool? DoNotBroadcast = default(bool?), string Section = default(string), Object Source = default(Object), string Specifics = default(string), bool? Synchronous = default(bool?), long? Timestamp = default(long?), string Type = default(string), CustomerConfig CustomerConfig = default(CustomerConfig))
        {
        ...
        {
            return this.Equals(input as RemoveCustomerEvent);
        }

        /// <summary>
        /// Returns true if RemoveCustomerEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveCustomerEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveCustomerEvent input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CustomerConfig == input.CustomerConfig ||
                    (this.CustomerConfig != null &&
                    this.CustomerConfig.Equals(input.CustomerConfig))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CustomerConfig != null)
                    hashCode = hashCode * 59 + this.CustomerConfig.GetHashCode();
                return hashCode;
            }
        }
