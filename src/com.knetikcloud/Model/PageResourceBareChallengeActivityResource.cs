...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceBareChallengeActivityResource :  IEquatable<PageResourceBareChallengeActivityResource>
    {
        ...
        {
            return this.Equals(input as PageResourceBareChallengeActivityResource);
        }

        /// <summary>
        /// Returns true if PageResourceBareChallengeActivityResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceBareChallengeActivityResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceBareChallengeActivityResource input)
        {
            if (input == null)
                return false;
