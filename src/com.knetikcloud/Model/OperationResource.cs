...
namespace com.knetikcloud.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OperationResource :  IEquatable<OperationResource>
    {
        /// <summary>
        ...
        public OperationResource(List<ExpressionResource> Args = default(List<ExpressionResource>), string Definition = default(string), string Op = default(string), string ReturnType = default(string), List<OperationDefinitionResource> SupportedOperators = default(List<OperationDefinitionResource>), string Type = default(string))
        {
            // to ensure "Args" is required (not null)
            if (Args == null)
            {
                throw new InvalidDataException("Args is a required property for OperationResource and cannot be null");
            }
            else
            {
                this.Args = Args;
            ...
            if (Op == null)
            {
                throw new InvalidDataException("Op is a required property for OperationResource and cannot be null");
            }
            else
            {
                this.Op = Op;
        ...
        {
            return this.Equals(input as OperationResource);
        }

        /// <summary>
        /// Returns true if OperationResource instances are equal
        /// </summary>
        /// <param name="input">Instance of OperationResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OperationResource input)
        {
            if (input == null)
                return false;
