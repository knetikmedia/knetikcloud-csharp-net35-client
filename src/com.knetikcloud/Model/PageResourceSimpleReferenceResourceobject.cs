...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceSimpleReferenceResourceobject :  IEquatable<PageResourceSimpleReferenceResourceobject>
    {
        ...
        {
            return this.Equals(input as PageResourceSimpleReferenceResourceobject);
        }

        /// <summary>
        /// Returns true if PageResourceSimpleReferenceResourceobject instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceSimpleReferenceResourceobject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceSimpleReferenceResourceobject input)
        {
            if (input == null)
                return false;
