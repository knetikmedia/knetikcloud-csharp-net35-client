...
namespace com.knetikcloud.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageResourcePaymentMethodTypeResource :  IEquatable<PageResourcePaymentMethodTypeResource>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageResourcePaymentMethodTypeResource" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PageResourcePaymentMethodTypeResource);
        }

        /// <summary>
        /// Returns true if PageResourcePaymentMethodTypeResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourcePaymentMethodTypeResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourcePaymentMethodTypeResource input)
        {
            if (input == null)
                return false;
