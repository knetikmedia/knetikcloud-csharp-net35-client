...
namespace com.knetikcloud.Model
{
    ...
    public partial class RewardSetResource :  IEquatable<RewardSetResource>
    {
        ...
        {
            return this.Equals(input as RewardSetResource);
        }

        /// <summary>
        /// Returns true if RewardSetResource instances are equal
        /// </summary>
        /// <param name="input">Instance of RewardSetResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RewardSetResource input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MaxPlacing == input.MaxPlacing ||
                    (this.MaxPlacing != null &&
                    this.MaxPlacing.Equals(input.MaxPlacing))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MaxPlacing != null)
                    hashCode = hashCode * 59 + this.MaxPlacing.GetHashCode();
                if (this.Name != null)
