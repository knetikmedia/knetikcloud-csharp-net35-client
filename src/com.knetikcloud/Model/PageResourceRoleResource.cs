...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceRoleResource :  IEquatable<PageResourceRoleResource>
    {
        ...
        {
            return this.Equals(input as PageResourceRoleResource);
        }

        /// <summary>
        /// Returns true if PageResourceRoleResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceRoleResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceRoleResource input)
        {
            if (input == null)
                return false;
