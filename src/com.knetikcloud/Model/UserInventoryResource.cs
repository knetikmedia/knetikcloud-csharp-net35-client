...
namespace com.knetikcloud.Model
{
    ...
    public partial class UserInventoryResource :  IEquatable<UserInventoryResource>
    {
        ...
        {
            return this.Equals(input as UserInventoryResource);
        }

        /// <summary>
        /// Returns true if UserInventoryResource instances are equal
        /// </summary>
        /// <param name="input">Instance of UserInventoryResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserInventoryResource input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.BehaviorData == input.BehaviorData ||
                    (this.BehaviorData != null &&
                    this.BehaviorData.Equals(input.BehaviorData))
                ) && 
                (
                ...
                (
                    this.ItemTypeHint == input.ItemTypeHint ||
                    (this.ItemTypeHint != null &&
                    this.ItemTypeHint.Equals(input.ItemTypeHint))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BehaviorData != null)
                    hashCode = hashCode * 59 + this.BehaviorData.GetHashCode();
                ...
                if (this.ItemTypeHint != null)
                    hashCode = hashCode * 59 + this.ItemTypeHint.GetHashCode();
                if (this.Status != null)
