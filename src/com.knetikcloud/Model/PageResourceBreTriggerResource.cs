...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceBreTriggerResource :  IEquatable<PageResourceBreTriggerResource>
    {
        ...
        {
            return this.Equals(input as PageResourceBreTriggerResource);
        }

        /// <summary>
        /// Returns true if PageResourceBreTriggerResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceBreTriggerResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceBreTriggerResource input)
        {
            if (input == null)
                return false;
