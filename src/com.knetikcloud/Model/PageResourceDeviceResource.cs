...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceDeviceResource :  IEquatable<PageResourceDeviceResource>
    {
        ...
        {
            return this.Equals(input as PageResourceDeviceResource);
        }

        /// <summary>
        /// Returns true if PageResourceDeviceResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceDeviceResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceDeviceResource input)
        {
            if (input == null)
                return false;
