...
namespace com.knetikcloud.Model
{
    ...
    public partial class MapResource :  IEquatable<MapResource>
    {
        ...
        public MapResource(string Definition = default(string), Dictionary<string, ExpressionResource> Map = default(Dictionary<string, ExpressionResource>), string Type = default(string))
        {
