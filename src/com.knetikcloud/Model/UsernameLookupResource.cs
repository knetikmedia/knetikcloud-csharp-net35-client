...
namespace com.knetikcloud.Model
{
    ...
    public partial class UsernameLookupResource :  IEquatable<UsernameLookupResource>
    {
        ...
        public UsernameLookupResource(string Definition = default(string), ExpressionResource LookupKey = default(ExpressionResource), string RequiredKeyType = default(string), string Type = default(string), string ValueType = default(string))
        {
