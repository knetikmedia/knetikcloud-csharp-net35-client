...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceStoreItemTemplateResource :  IEquatable<PageResourceStoreItemTemplateResource>
    {
        ...
        {
            return this.Equals(input as PageResourceStoreItemTemplateResource);
        }

        /// <summary>
        /// Returns true if PageResourceStoreItemTemplateResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceStoreItemTemplateResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceStoreItemTemplateResource input)
        {
            if (input == null)
                return false;
