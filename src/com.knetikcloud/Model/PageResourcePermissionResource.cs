...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourcePermissionResource :  IEquatable<PageResourcePermissionResource>
    {
        ...
        {
            return this.Equals(input as PageResourcePermissionResource);
        }

        /// <summary>
        /// Returns true if PageResourcePermissionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourcePermissionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourcePermissionResource input)
        {
            if (input == null)
                return false;
