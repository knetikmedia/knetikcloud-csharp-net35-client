...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceDispositionResource :  IEquatable<PageResourceDispositionResource>
    {
        ...
        {
            return this.Equals(input as PageResourceDispositionResource);
        }

        /// <summary>
        /// Returns true if PageResourceDispositionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceDispositionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceDispositionResource input)
        {
            if (input == null)
                return false;
