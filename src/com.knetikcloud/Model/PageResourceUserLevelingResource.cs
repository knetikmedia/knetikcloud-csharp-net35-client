...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceUserLevelingResource :  IEquatable<PageResourceUserLevelingResource>
    {
        ...
        {
            return this.Equals(input as PageResourceUserLevelingResource);
        }

        /// <summary>
        /// Returns true if PageResourceUserLevelingResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceUserLevelingResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceUserLevelingResource input)
        {
            if (input == null)
                return false;
