...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceChallengeResource :  IEquatable<PageResourceChallengeResource>
    {
        ...
        {
            return this.Equals(input as PageResourceChallengeResource);
        }

        /// <summary>
        /// Returns true if PageResourceChallengeResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceChallengeResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceChallengeResource input)
        {
            if (input == null)
                return false;
