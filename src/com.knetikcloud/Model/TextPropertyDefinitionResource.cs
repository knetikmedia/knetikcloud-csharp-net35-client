...
namespace com.knetikcloud.Model
{
    ...
    public partial class TextPropertyDefinitionResource : PropertyDefinitionResource,  IEquatable<TextPropertyDefinitionResource>
    {
        ...
        public TextPropertyDefinitionResource(string Description = default(string), PropertyFieldListResource FieldList = default(PropertyFieldListResource), string FriendlyName = default(string), string Name = default(string), string OptionLabelPath = default(string), string OptionValuePath = default(string), string OptionsUrl = default(string), bool? Required = default(bool?), string Type = default(string), int? MaxLength = default(int?))
        {
