...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceSubscriptionTemplateResource :  IEquatable<PageResourceSubscriptionTemplateResource>
    {
        ...
        {
            return this.Equals(input as PageResourceSubscriptionTemplateResource);
        }

        /// <summary>
        /// Returns true if PageResourceSubscriptionTemplateResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceSubscriptionTemplateResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceSubscriptionTemplateResource input)
        {
            if (input == null)
                return false;
