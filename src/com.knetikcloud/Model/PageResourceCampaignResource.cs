...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceCampaignResource :  IEquatable<PageResourceCampaignResource>
    {
        ...
        {
            return this.Equals(input as PageResourceCampaignResource);
        }

        /// <summary>
        /// Returns true if PageResourceCampaignResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceCampaignResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceCampaignResource input)
        {
            if (input == null)
                return false;
