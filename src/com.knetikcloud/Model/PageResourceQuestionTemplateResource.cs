...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceQuestionTemplateResource :  IEquatable<PageResourceQuestionTemplateResource>
    {
        ...
        {
            return this.Equals(input as PageResourceQuestionTemplateResource);
        }

        /// <summary>
        /// Returns true if PageResourceQuestionTemplateResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceQuestionTemplateResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceQuestionTemplateResource input)
        {
            if (input == null)
                return false;
