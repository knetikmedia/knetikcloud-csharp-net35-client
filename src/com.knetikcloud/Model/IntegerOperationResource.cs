...
namespace com.knetikcloud.Model
{
    ...
    public partial class IntegerOperationResource :  IEquatable<IntegerOperationResource>
    {
        ...
        protected IntegerOperationResource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegerOperationResource" /> class.
        /// </summary>
        ...
        public IntegerOperationResource(List<ExpressionResource> Args = default(List<ExpressionResource>), string Definition = default(string), string Op = default(string), string ReturnType = default(string), List<OperationDefinitionResource> SupportedOperators = default(List<OperationDefinitionResource>), string Type = default(string))
        {
            // to ensure "Args" is required (not null)
            if (Args == null)
            {
                throw new InvalidDataException("Args is a required property for IntegerOperationResource and cannot be null");
            }
            else
            {
                this.Args = Args;
            ...
            if (Op == null)
            {
                throw new InvalidDataException("Op is a required property for IntegerOperationResource and cannot be null");
            }
            else
            {
                this.Op = Op;
