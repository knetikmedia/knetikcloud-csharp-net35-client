...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceQuestionResource :  IEquatable<PageResourceQuestionResource>
    {
        ...
        {
            return this.Equals(input as PageResourceQuestionResource);
        }

        /// <summary>
        /// Returns true if PageResourceQuestionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceQuestionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceQuestionResource input)
        {
            if (input == null)
                return false;
