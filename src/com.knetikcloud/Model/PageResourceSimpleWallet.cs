...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceSimpleWallet :  IEquatable<PageResourceSimpleWallet>
    {
        ...
        {
            return this.Equals(input as PageResourceSimpleWallet);
        }

        /// <summary>
        /// Returns true if PageResourceSimpleWallet instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceSimpleWallet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceSimpleWallet input)
        {
            if (input == null)
                return false;
