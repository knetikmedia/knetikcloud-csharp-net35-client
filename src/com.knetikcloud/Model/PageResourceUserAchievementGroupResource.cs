...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceUserAchievementGroupResource :  IEquatable<PageResourceUserAchievementGroupResource>
    {
        ...
        {
            return this.Equals(input as PageResourceUserAchievementGroupResource);
        }

        /// <summary>
        /// Returns true if PageResourceUserAchievementGroupResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceUserAchievementGroupResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceUserAchievementGroupResource input)
        {
            if (input == null)
                return false;
