...
namespace com.knetikcloud.Model
{
    ...
    public partial class RewardItemResource :  IEquatable<RewardItemResource>
    {
        ...
        {
            return this.Equals(input as RewardItemResource);
        }

        /// <summary>
        /// Returns true if RewardItemResource instances are equal
        /// </summary>
        /// <param name="input">Instance of RewardItemResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RewardItemResource input)
        {
            if (input == null)
                return false;
