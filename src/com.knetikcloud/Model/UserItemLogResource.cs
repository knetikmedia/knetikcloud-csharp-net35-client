...
namespace com.knetikcloud.Model
{
    ...
    public partial class UserItemLogResource :  IEquatable<UserItemLogResource>
    {
        ...
        {
            return this.Equals(input as UserItemLogResource);
        }

        /// <summary>
        /// Returns true if UserItemLogResource instances are equal
        /// </summary>
        /// <param name="input">Instance of UserItemLogResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserItemLogResource input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.UserInventory == input.UserInventory ||
                    (this.UserInventory != null &&
                    this.UserInventory.Equals(input.UserInventory))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UserInventory != null)
                    hashCode = hashCode * 59 + this.UserInventory.GetHashCode();
                return hashCode;
            }
        }
