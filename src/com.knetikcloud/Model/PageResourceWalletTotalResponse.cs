...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceWalletTotalResponse :  IEquatable<PageResourceWalletTotalResponse>
    {
        ...
        {
            return this.Equals(input as PageResourceWalletTotalResponse);
        }

        /// <summary>
        /// Returns true if PageResourceWalletTotalResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceWalletTotalResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceWalletTotalResponse input)
        {
            if (input == null)
                return false;
