...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceStoreItem :  IEquatable<PageResourceStoreItem>
    {
        ...
        {
            return this.Equals(input as PageResourceStoreItem);
        }

        /// <summary>
        /// Returns true if PageResourceStoreItem instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceStoreItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceStoreItem input)
        {
            if (input == null)
                return false;
