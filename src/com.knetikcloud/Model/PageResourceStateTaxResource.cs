...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceStateTaxResource :  IEquatable<PageResourceStateTaxResource>
    {
        ...
        {
            return this.Equals(input as PageResourceStateTaxResource);
        }

        /// <summary>
        /// Returns true if PageResourceStateTaxResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceStateTaxResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceStateTaxResource input)
        {
            if (input == null)
                return false;
