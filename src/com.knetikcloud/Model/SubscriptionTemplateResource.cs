...
namespace com.knetikcloud.Model
{
    ...
    public partial class SubscriptionTemplateResource :  IEquatable<SubscriptionTemplateResource>
    {
        ...
        public SubscriptionTemplateResource(bool? AllowAdditional = default(bool?), string Name = default(string), TemplateResource PlanTemplate = default(TemplateResource), List<PropertyDefinitionResource> Properties = default(List<PropertyDefinitionResource>))
        {
        ...
        {
            return this.Equals(input as SubscriptionTemplateResource);
        }

        /// <summary>
        /// Returns true if SubscriptionTemplateResource instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionTemplateResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionTemplateResource input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PlanTemplate == input.PlanTemplate ||
                    (this.PlanTemplate != null &&
                    this.PlanTemplate.Equals(input.PlanTemplate))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PlanTemplate != null)
                    hashCode = hashCode * 59 + this.PlanTemplate.GetHashCode();
