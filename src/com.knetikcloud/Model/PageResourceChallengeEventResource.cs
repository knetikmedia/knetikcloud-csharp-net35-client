...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceChallengeEventResource :  IEquatable<PageResourceChallengeEventResource>
    {
        ...
        {
            return this.Equals(input as PageResourceChallengeEventResource);
        }

        /// <summary>
        /// Returns true if PageResourceChallengeEventResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceChallengeEventResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceChallengeEventResource input)
        {
            if (input == null)
                return false;
