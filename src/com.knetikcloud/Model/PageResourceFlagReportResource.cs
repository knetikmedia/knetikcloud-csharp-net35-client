...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceFlagReportResource :  IEquatable<PageResourceFlagReportResource>
    {
        ...
        {
            return this.Equals(input as PageResourceFlagReportResource);
        }

        /// <summary>
        /// Returns true if PageResourceFlagReportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceFlagReportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceFlagReportResource input)
        {
            if (input == null)
                return false;
