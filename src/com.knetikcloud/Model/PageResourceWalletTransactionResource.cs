...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceWalletTransactionResource :  IEquatable<PageResourceWalletTransactionResource>
    {
        ...
        {
            return this.Equals(input as PageResourceWalletTransactionResource);
        }

        /// <summary>
        /// Returns true if PageResourceWalletTransactionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceWalletTransactionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceWalletTransactionResource input)
        {
            if (input == null)
                return false;
