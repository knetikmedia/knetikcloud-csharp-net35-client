...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceCartSummary :  IEquatable<PageResourceCartSummary>
    {
        ...
        {
            return this.Equals(input as PageResourceCartSummary);
        }

        /// <summary>
        /// Returns true if PageResourceCartSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceCartSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceCartSummary input)
        {
            if (input == null)
                return false;
