...
namespace com.knetikcloud.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebsocketSendTopicMessageEvent : BroadcastableEvent,  IEquatable<WebsocketSendTopicMessageEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebsocketSendTopicMessageEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebsocketSendTopicMessageEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebsocketSendTopicMessageEvent" /> class.
        /// </summary>
        ...
        public WebsocketSendTopicMessageEvent(string _Client = default(string), string Customer = default(string), bool? DoNotBroadcast = default(bool?), string Section = default(string), Object Source = default(Object), string Specifics = default(string), bool? Synchronous = default(bool?), long? Timestamp = default(long?), string Type = default(string), Object Content = default(Object), string Topic = default(string))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for WebsocketSendTopicMessageEvent and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        {
            return this.Equals(input as WebsocketSendTopicMessageEvent);
        }

        /// <summary>
        /// Returns true if WebsocketSendTopicMessageEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of WebsocketSendTopicMessageEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebsocketSendTopicMessageEvent input)
        {
            if (input == null)
                return false;
