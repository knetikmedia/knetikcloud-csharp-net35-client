...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourcePollResource :  IEquatable<PageResourcePollResource>
    {
        ...
        {
            return this.Equals(input as PageResourcePollResource);
        }

        /// <summary>
        /// Returns true if PageResourcePollResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourcePollResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourcePollResource input)
        {
            if (input == null)
                return false;
