...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceInvoiceLogEntry :  IEquatable<PageResourceInvoiceLogEntry>
    {
        ...
        {
            return this.Equals(input as PageResourceInvoiceLogEntry);
        }

        /// <summary>
        /// Returns true if PageResourceInvoiceLogEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceInvoiceLogEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceInvoiceLogEntry input)
        {
            if (input == null)
                return false;
