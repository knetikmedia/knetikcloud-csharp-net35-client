...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceSubscriptionResource :  IEquatable<PageResourceSubscriptionResource>
    {
        ...
        {
            return this.Equals(input as PageResourceSubscriptionResource);
        }

        /// <summary>
        /// Returns true if PageResourceSubscriptionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceSubscriptionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceSubscriptionResource input)
        {
            if (input == null)
                return false;
