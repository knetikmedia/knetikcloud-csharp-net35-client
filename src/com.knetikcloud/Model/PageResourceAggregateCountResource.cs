...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceAggregateCountResource :  IEquatable<PageResourceAggregateCountResource>
    {
        ...
        {
            return this.Equals(input as PageResourceAggregateCountResource);
        }

        /// <summary>
        /// Returns true if PageResourceAggregateCountResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceAggregateCountResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceAggregateCountResource input)
        {
            if (input == null)
                return false;
