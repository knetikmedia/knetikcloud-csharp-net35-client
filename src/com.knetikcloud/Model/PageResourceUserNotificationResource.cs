...
namespace com.knetikcloud.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageResourceUserNotificationResource :  IEquatable<PageResourceUserNotificationResource>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageResourceUserNotificationResource" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PageResourceUserNotificationResource);
        }

        /// <summary>
        /// Returns true if PageResourceUserNotificationResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceUserNotificationResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceUserNotificationResource input)
        {
            if (input == null)
                return false;
