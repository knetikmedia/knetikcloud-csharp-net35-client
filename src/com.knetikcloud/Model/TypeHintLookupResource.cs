...
namespace com.knetikcloud.Model
{
    ...
    public partial class TypeHintLookupResource :  IEquatable<TypeHintLookupResource>
    {
        ...
        public TypeHintLookupResource(string Definition = default(string), ExpressionResource LookupKey = default(ExpressionResource), string RequiredKeyType = default(string), string Type = default(string), string ValueType = default(string))
        {
        ...
        {
            return this.Equals(input as TypeHintLookupResource);
        }

        /// <summary>
        /// Returns true if TypeHintLookupResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TypeHintLookupResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TypeHintLookupResource input)
        {
            if (input == null)
                return false;
