...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceFulfillmentType :  IEquatable<PageResourceFulfillmentType>
    {
        ...
        {
            return this.Equals(input as PageResourceFulfillmentType);
        }

        /// <summary>
        /// Returns true if PageResourceFulfillmentType instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceFulfillmentType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceFulfillmentType input)
        {
            if (input == null)
                return false;
