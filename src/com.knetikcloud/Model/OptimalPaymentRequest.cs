...
namespace com.knetikcloud.Model
{
    ...
    public partial class OptimalPaymentRequest :  IEquatable<OptimalPaymentRequest>
    {
        ...
        {
            return this.Equals(input as OptimalPaymentRequest);
        }

        /// <summary>
        /// Returns true if OptimalPaymentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimalPaymentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimalPaymentRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OnDecline == input.OnDecline ||
                    (this.OnDecline != null &&
                    this.OnDecline.Equals(input.OnDecline))
                ) && 
                (
                    this.OnError == input.OnError ||
                    (this.OnError != null &&
                    this.OnError.Equals(input.OnError))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OnDecline != null)
                    hashCode = hashCode * 59 + this.OnDecline.GetHashCode();
                if (this.OnError != null)
                    hashCode = hashCode * 59 + this.OnError.GetHashCode();
