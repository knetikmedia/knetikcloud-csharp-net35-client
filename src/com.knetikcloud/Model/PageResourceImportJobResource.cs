...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceImportJobResource :  IEquatable<PageResourceImportJobResource>
    {
        ...
        {
            return this.Equals(input as PageResourceImportJobResource);
        }

        /// <summary>
        /// Returns true if PageResourceImportJobResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceImportJobResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceImportJobResource input)
        {
            if (input == null)
                return false;
