...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceTransactionResource :  IEquatable<PageResourceTransactionResource>
    {
        ...
        {
            return this.Equals(input as PageResourceTransactionResource);
        }

        /// <summary>
        /// Returns true if PageResourceTransactionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceTransactionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceTransactionResource input)
        {
            if (input == null)
                return false;
