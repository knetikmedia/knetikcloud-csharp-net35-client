...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceInvoiceResource :  IEquatable<PageResourceInvoiceResource>
    {
        ...
        {
            return this.Equals(input as PageResourceInvoiceResource);
        }

        /// <summary>
        /// Returns true if PageResourceInvoiceResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceInvoiceResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceInvoiceResource input)
        {
            if (input == null)
                return false;
