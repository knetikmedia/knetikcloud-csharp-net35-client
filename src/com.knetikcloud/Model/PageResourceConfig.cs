...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceConfig :  IEquatable<PageResourceConfig>
    {
        ...
        {
            return this.Equals(input as PageResourceConfig);
        }

        /// <summary>
        /// Returns true if PageResourceConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceConfig input)
        {
            if (input == null)
                return false;
