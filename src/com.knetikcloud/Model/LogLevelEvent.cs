...
namespace com.knetikcloud.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LogLevelEvent : BroadcastableEvent,  IEquatable<LogLevelEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogLevelEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LogLevelEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LogLevelEvent" /> class.
        /// </summary>
        ...
        public LogLevelEvent(string _Client = default(string), string Customer = default(string), bool? DoNotBroadcast = default(bool?), string Section = default(string), Object Source = default(Object), string Specifics = default(string), bool? Synchronous = default(bool?), long? Timestamp = default(long?), string Type = default(string), string Level = default(string), string Name = default(string))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for LogLevelEvent and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        {
            return this.Equals(input as LogLevelEvent);
        }

        /// <summary>
        /// Returns true if LogLevelEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of LogLevelEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogLevelEvent input)
        {
            if (input == null)
                return false;
