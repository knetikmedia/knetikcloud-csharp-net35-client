...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceArticleResource :  IEquatable<PageResourceArticleResource>
    {
        ...
        {
            return this.Equals(input as PageResourceArticleResource);
        }

        /// <summary>
        /// Returns true if PageResourceArticleResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceArticleResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceArticleResource input)
        {
            if (input == null)
                return false;
