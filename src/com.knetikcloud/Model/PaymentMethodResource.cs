...
namespace com.knetikcloud.Model
{
    ...
    public partial class PaymentMethodResource :  IEquatable<PaymentMethodResource>
    {
        ...
        {
            return this.Equals(input as PaymentMethodResource);
        }

        /// <summary>
        /// Returns true if PaymentMethodResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentMethodResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentMethodResource input)
        {
            if (input == null)
                return false;
