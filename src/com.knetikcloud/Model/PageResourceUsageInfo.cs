...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceUsageInfo :  IEquatable<PageResourceUsageInfo>
    {
        ...
        {
            return this.Equals(input as PageResourceUsageInfo);
        }

        /// <summary>
        /// Returns true if PageResourceUsageInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceUsageInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceUsageInfo input)
        {
            if (input == null)
                return false;
