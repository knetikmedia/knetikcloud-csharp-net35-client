...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceArtistResource :  IEquatable<PageResourceArtistResource>
    {
        ...
        {
            return this.Equals(input as PageResourceArtistResource);
        }

        /// <summary>
        /// Returns true if PageResourceArtistResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceArtistResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceArtistResource input)
        {
            if (input == null)
                return false;
