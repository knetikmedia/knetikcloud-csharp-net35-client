...
namespace com.knetikcloud.Model
{
    ...
    public partial class BreGlobalResource :  IEquatable<BreGlobalResource>
    {
        ...
        {
            return this.Equals(input as BreGlobalResource);
        }

        /// <summary>
        /// Returns true if BreGlobalResource instances are equal
        /// </summary>
        /// <param name="input">Instance of BreGlobalResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BreGlobalResource input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SystemGlobal == input.SystemGlobal ||
                    (this.SystemGlobal != null &&
                    this.SystemGlobal.Equals(input.SystemGlobal))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SystemGlobal != null)
                    hashCode = hashCode * 59 + this.SystemGlobal.GetHashCode();
                if (this.Type != null)
