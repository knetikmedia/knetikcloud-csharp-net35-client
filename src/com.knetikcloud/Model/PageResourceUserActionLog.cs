...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceUserActionLog :  IEquatable<PageResourceUserActionLog>
    {
        ...
        {
            return this.Equals(input as PageResourceUserActionLog);
        }

        /// <summary>
        /// Returns true if PageResourceUserActionLog instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceUserActionLog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceUserActionLog input)
        {
            if (input == null)
                return false;
