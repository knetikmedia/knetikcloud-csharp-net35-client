...
namespace com.knetikcloud.Model
{
    ...
    public partial class BroadcastableEvent :  IEquatable<BroadcastableEvent>
    {
        ...
        public BroadcastableEvent(string _Client = default(string), string Customer = default(string), bool? DoNotBroadcast = default(bool?), string Section = default(string), Object Source = default(Object), string Specifics = default(string), bool? Synchronous = default(bool?), long? Timestamp = default(long?), string Type = default(string))
        {
        ...
        {
            return this.Equals(input as BroadcastableEvent);
        }

        /// <summary>
        /// Returns true if BroadcastableEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of BroadcastableEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BroadcastableEvent input)
        {
            if (input == null)
                return false;
