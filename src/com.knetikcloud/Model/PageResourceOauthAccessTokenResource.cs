...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceOauthAccessTokenResource :  IEquatable<PageResourceOauthAccessTokenResource>
    {
        ...
        {
            return this.Equals(input as PageResourceOauthAccessTokenResource);
        }

        /// <summary>
        /// Returns true if PageResourceOauthAccessTokenResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceOauthAccessTokenResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceOauthAccessTokenResource input)
        {
            if (input == null)
                return false;
