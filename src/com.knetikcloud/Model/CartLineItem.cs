...
namespace com.knetikcloud.Model
{
    ...
    public partial class CartLineItem :  IEquatable<CartLineItem>
    {
        ...
        public CartLineItem(string CurrencyCode = default(string), string Description = default(string), Discount Discount = default(Discount), decimal? LineTotal = default(decimal?), string Name = default(string), decimal? OriginalLineTotal = default(decimal?), decimal? OriginalUnitPrice = default(decimal?), int? Qty = default(int?), string SaleName = default(string), string Sku = default(string), string SkuDescription = default(string), int? StoreItemId = default(int?), List<string> Tags = default(List<string>), string ThumbUrl = default(string), string UniqueKey = default(string), decimal? UnitPrice = default(decimal?), int? VendorId = default(int?), string VendorName = default(string))
        {
