...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceForwardLog :  IEquatable<PageResourceForwardLog>
    {
        ...
        {
            return this.Equals(input as PageResourceForwardLog);
        }

        /// <summary>
        /// Returns true if PageResourceForwardLog instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceForwardLog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceForwardLog input)
        {
            if (input == null)
                return false;
