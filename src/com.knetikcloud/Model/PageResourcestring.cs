...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourcestring :  IEquatable<PageResourcestring>
    {
        ...
        {
            return this.Equals(input as PageResourcestring);
        }

        /// <summary>
        /// Returns true if PageResourcestring instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourcestring to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourcestring input)
        {
            if (input == null)
                return false;
