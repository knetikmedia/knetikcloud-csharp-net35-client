...
namespace com.knetikcloud.Model
{
    ...
    public partial class ClientResource :  IEquatable<ClientResource>
    {
        ...
        {
            return this.Equals(input as ClientResource);
        }

        /// <summary>
        /// Returns true if ClientResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientResource input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AccessTokenValiditySeconds == input.AccessTokenValiditySeconds ||
                    (this.AccessTokenValiditySeconds != null &&
                    this.AccessTokenValiditySeconds.Equals(input.AccessTokenValiditySeconds))
                ) && 
                (
                ...
                (
                    this.RefreshTokenValiditySeconds == input.RefreshTokenValiditySeconds ||
                    (this.RefreshTokenValiditySeconds != null &&
                    this.RefreshTokenValiditySeconds.Equals(input.RefreshTokenValiditySeconds))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AccessTokenValiditySeconds != null)
                    hashCode = hashCode * 59 + this.AccessTokenValiditySeconds.GetHashCode();
                ...
                if (this.RefreshTokenValiditySeconds != null)
                    hashCode = hashCode * 59 + this.RefreshTokenValiditySeconds.GetHashCode();
                if (this.Secret != null)
