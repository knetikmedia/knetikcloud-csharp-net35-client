...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceAggregateInvoiceReportResource :  IEquatable<PageResourceAggregateInvoiceReportResource>
    {
        ...
        {
            return this.Equals(input as PageResourceAggregateInvoiceReportResource);
        }

        /// <summary>
        /// Returns true if PageResourceAggregateInvoiceReportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceAggregateInvoiceReportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceAggregateInvoiceReportResource input)
        {
            if (input == null)
                return false;
