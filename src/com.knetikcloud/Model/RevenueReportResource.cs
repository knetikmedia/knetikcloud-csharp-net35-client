...
namespace com.knetikcloud.Model
{
    ...
    public partial class RevenueReportResource :  IEquatable<RevenueReportResource>
    {
        ...
        public RevenueReportResource(long? CustomerCount = default(long?), long? SaleCount = default(long?), decimal? SalesAverage = default(decimal?), decimal? SalesTotal = default(decimal?))
        {
