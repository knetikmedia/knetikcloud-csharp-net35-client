...
namespace com.knetikcloud.Model
{
    ...
    public partial class WalletTransactionResource :  IEquatable<WalletTransactionResource>
    {
        ...
        {
            return this.Equals(input as WalletTransactionResource);
        }

        /// <summary>
        /// Returns true if WalletTransactionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of WalletTransactionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WalletTransactionResource input)
        {
            if (input == null)
                return false;
