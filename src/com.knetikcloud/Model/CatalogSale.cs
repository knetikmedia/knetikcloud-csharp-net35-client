...
namespace com.knetikcloud.Model
{
    ...
    public partial class CatalogSale :  IEquatable<CatalogSale>
    {
        ...
        {
            return this.Equals(input as CatalogSale);
        }

        /// <summary>
        /// Returns true if CatalogSale instances are equal
        /// </summary>
        /// <param name="input">Instance of CatalogSale to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogSale input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SaleEndDate == input.SaleEndDate ||
                    (this.SaleEndDate != null &&
                    this.SaleEndDate.Equals(input.SaleEndDate))
                ) && 
                (
                    this.SaleStartDate == input.SaleStartDate ||
                    (this.SaleStartDate != null &&
                    this.SaleStartDate.Equals(input.SaleStartDate))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SaleEndDate != null)
                    hashCode = hashCode * 59 + this.SaleEndDate.GetHashCode();
                if (this.SaleStartDate != null)
                    hashCode = hashCode * 59 + this.SaleStartDate.GetHashCode();
