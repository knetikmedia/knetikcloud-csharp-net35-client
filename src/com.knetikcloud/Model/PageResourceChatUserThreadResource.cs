...
namespace com.knetikcloud.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageResourceChatUserThreadResource :  IEquatable<PageResourceChatUserThreadResource>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageResourceChatUserThreadResource" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PageResourceChatUserThreadResource);
        }

        /// <summary>
        /// Returns true if PageResourceChatUserThreadResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceChatUserThreadResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceChatUserThreadResource input)
        {
            if (input == null)
                return false;
