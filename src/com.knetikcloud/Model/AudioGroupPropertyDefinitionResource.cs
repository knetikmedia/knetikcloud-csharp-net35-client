...
namespace com.knetikcloud.Model
{
    ...
    public partial class AudioGroupPropertyDefinitionResource : FileGroupPropertyDefinitionResource,  IEquatable<AudioGroupPropertyDefinitionResource>
    {
        ...
        public AudioGroupPropertyDefinitionResource(string Description = default(string), PropertyFieldListResource FieldList = default(PropertyFieldListResource), string FriendlyName = default(string), string Name = default(string), string OptionLabelPath = default(string), string OptionValuePath = default(string), string OptionsUrl = default(string), bool? Required = default(bool?), string Type = default(string), string FileType = default(string), int? MaxCount = default(int?), long? MaxFileSize = default(long?), int? MinCount = default(int?), int? MaxLength = default(int?), int? MinLength = default(int?))
        {
