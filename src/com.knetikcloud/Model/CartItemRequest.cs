...
namespace com.knetikcloud.Model
{
    ...
    public partial class CartItemRequest :  IEquatable<CartItemRequest>
    {
        ...
        public CartItemRequest(string AffiliateKey = default(string), string CatalogSku = default(string), decimal? PriceOverride = default(decimal?), int? Quantity = default(int?))
        {
