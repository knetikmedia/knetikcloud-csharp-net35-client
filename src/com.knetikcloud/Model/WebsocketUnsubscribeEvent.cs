...
namespace com.knetikcloud.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebsocketUnsubscribeEvent : BroadcastableEvent,  IEquatable<WebsocketUnsubscribeEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebsocketUnsubscribeEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebsocketUnsubscribeEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebsocketUnsubscribeEvent" /> class.
        /// </summary>
        ...
        /// <param name="TopicSubscriber">TopicSubscriber.</param>
        public WebsocketUnsubscribeEvent(string _Client = default(string), string Customer = default(string), bool? DoNotBroadcast = default(bool?), string Section = default(string), Object Source = default(Object), string Specifics = default(string), bool? Synchronous = default(bool?), long? Timestamp = default(long?), string Type = default(string), Topic Topic = default(Topic), TopicSubscriber TopicSubscriber = default(TopicSubscriber))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for WebsocketUnsubscribeEvent and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        {
            return this.Equals(input as WebsocketUnsubscribeEvent);
        }

        /// <summary>
        /// Returns true if WebsocketUnsubscribeEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of WebsocketUnsubscribeEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebsocketUnsubscribeEvent input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TopicSubscriber == input.TopicSubscriber ||
                    (this.TopicSubscriber != null &&
                    this.TopicSubscriber.Equals(input.TopicSubscriber))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TopicSubscriber != null)
                    hashCode = hashCode * 59 + this.TopicSubscriber.GetHashCode();
                return hashCode;
            }
        }
