...
namespace com.knetikcloud.Model
{
    ...
    public partial class StringOperationResource :  IEquatable<StringOperationResource>
    {
        ...
        protected StringOperationResource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StringOperationResource" /> class.
        /// </summary>
        ...
        public StringOperationResource(List<ExpressionResource> Args = default(List<ExpressionResource>), string Definition = default(string), string Op = default(string), string ReturnType = default(string), List<OperationDefinitionResource> SupportedOperators = default(List<OperationDefinitionResource>), string Type = default(string))
        {
            // to ensure "Args" is required (not null)
            if (Args == null)
            {
                throw new InvalidDataException("Args is a required property for StringOperationResource and cannot be null");
            }
            else
            {
                this.Args = Args;
            ...
            if (Op == null)
            {
                throw new InvalidDataException("Op is a required property for StringOperationResource and cannot be null");
            }
            else
            {
                this.Op = Op;
        ...
        {
            return this.Equals(input as StringOperationResource);
        }

        /// <summary>
        /// Returns true if StringOperationResource instances are equal
        /// </summary>
        /// <param name="input">Instance of StringOperationResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringOperationResource input)
        {
            if (input == null)
                return false;
