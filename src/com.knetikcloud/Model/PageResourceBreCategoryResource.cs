...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceBreCategoryResource :  IEquatable<PageResourceBreCategoryResource>
    {
        ...
        {
            return this.Equals(input as PageResourceBreCategoryResource);
        }

        /// <summary>
        /// Returns true if PageResourceBreCategoryResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceBreCategoryResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceBreCategoryResource input)
        {
            if (input == null)
                return false;
