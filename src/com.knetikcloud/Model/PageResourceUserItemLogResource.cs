...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceUserItemLogResource :  IEquatable<PageResourceUserItemLogResource>
    {
        ...
        {
            return this.Equals(input as PageResourceUserItemLogResource);
        }

        /// <summary>
        /// Returns true if PageResourceUserItemLogResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceUserItemLogResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceUserItemLogResource input)
        {
            if (input == null)
                return false;
