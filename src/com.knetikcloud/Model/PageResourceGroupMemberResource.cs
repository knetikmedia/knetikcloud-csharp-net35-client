...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceGroupMemberResource :  IEquatable<PageResourceGroupMemberResource>
    {
        ...
        {
            return this.Equals(input as PageResourceGroupMemberResource);
        }

        /// <summary>
        /// Returns true if PageResourceGroupMemberResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceGroupMemberResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceGroupMemberResource input)
        {
            if (input == null)
                return false;
