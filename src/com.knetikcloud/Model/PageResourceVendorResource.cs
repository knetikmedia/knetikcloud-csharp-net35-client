...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceVendorResource :  IEquatable<PageResourceVendorResource>
    {
        ...
        {
            return this.Equals(input as PageResourceVendorResource);
        }

        /// <summary>
        /// Returns true if PageResourceVendorResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceVendorResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceVendorResource input)
        {
            if (input == null)
                return false;
