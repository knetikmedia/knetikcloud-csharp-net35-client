...
namespace com.knetikcloud.Model
{
    ...
    public partial class EntitlementGrantRequest :  IEquatable<EntitlementGrantRequest>
    {
        ...
        {
            return this.Equals(input as EntitlementGrantRequest);
        }

        /// <summary>
        /// Returns true if EntitlementGrantRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EntitlementGrantRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntitlementGrantRequest input)
        {
            if (input == null)
                return false;
