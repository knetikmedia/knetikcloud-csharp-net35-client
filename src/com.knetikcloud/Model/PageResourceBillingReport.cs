...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceBillingReport :  IEquatable<PageResourceBillingReport>
    {
        ...
        {
            return this.Equals(input as PageResourceBillingReport);
        }

        /// <summary>
        /// Returns true if PageResourceBillingReport instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceBillingReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceBillingReport input)
        {
            if (input == null)
                return false;
