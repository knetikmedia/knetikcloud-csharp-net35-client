...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceBareActivityResource :  IEquatable<PageResourceBareActivityResource>
    {
        ...
        {
            return this.Equals(input as PageResourceBareActivityResource);
        }

        /// <summary>
        /// Returns true if PageResourceBareActivityResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceBareActivityResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceBareActivityResource input)
        {
            if (input == null)
                return false;
