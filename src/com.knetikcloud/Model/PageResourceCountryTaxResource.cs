...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceCountryTaxResource :  IEquatable<PageResourceCountryTaxResource>
    {
        ...
        {
            return this.Equals(input as PageResourceCountryTaxResource);
        }

        /// <summary>
        /// Returns true if PageResourceCountryTaxResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceCountryTaxResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceCountryTaxResource input)
        {
            if (input == null)
                return false;
