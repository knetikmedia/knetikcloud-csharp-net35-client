...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceCategoryResource :  IEquatable<PageResourceCategoryResource>
    {
        ...
        {
            return this.Equals(input as PageResourceCategoryResource);
        }

        /// <summary>
        /// Returns true if PageResourceCategoryResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceCategoryResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceCategoryResource input)
        {
            if (input == null)
                return false;
