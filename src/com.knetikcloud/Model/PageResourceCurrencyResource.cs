...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceCurrencyResource :  IEquatable<PageResourceCurrencyResource>
    {
        ...
        {
            return this.Equals(input as PageResourceCurrencyResource);
        }

        /// <summary>
        /// Returns true if PageResourceCurrencyResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceCurrencyResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceCurrencyResource input)
        {
            if (input == null)
                return false;
