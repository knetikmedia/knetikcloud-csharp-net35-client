...
namespace com.knetikcloud.Model
{
    ...
    public partial class SimpleReferenceResourceint :  IEquatable<SimpleReferenceResourceint>
    {
        ...
        {
            return this.Equals(input as SimpleReferenceResourceint);
        }

        /// <summary>
        /// Returns true if SimpleReferenceResourceint instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleReferenceResourceint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleReferenceResourceint input)
        {
            if (input == null)
                return false;
