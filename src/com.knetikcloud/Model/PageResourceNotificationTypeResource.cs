...
namespace com.knetikcloud.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageResourceNotificationTypeResource :  IEquatable<PageResourceNotificationTypeResource>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageResourceNotificationTypeResource" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PageResourceNotificationTypeResource);
        }

        /// <summary>
        /// Returns true if PageResourceNotificationTypeResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceNotificationTypeResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceNotificationTypeResource input)
        {
            if (input == null)
                return false;
