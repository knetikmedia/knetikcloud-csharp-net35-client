...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceUserInventoryResource :  IEquatable<PageResourceUserInventoryResource>
    {
        ...
        {
            return this.Equals(input as PageResourceUserInventoryResource);
        }

        /// <summary>
        /// Returns true if PageResourceUserInventoryResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceUserInventoryResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceUserInventoryResource input)
        {
            if (input == null)
                return false;
