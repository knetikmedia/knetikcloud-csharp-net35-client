...
namespace com.knetikcloud.Model
{
    ...
    public partial class PageResourceUserBaseResource :  IEquatable<PageResourceUserBaseResource>
    {
        ...
        {
            return this.Equals(input as PageResourceUserBaseResource);
        }

        /// <summary>
        /// Returns true if PageResourceUserBaseResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PageResourceUserBaseResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageResourceUserBaseResource input)
        {
            if (input == null)
                return false;
