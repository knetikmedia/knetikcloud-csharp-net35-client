...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IPayments_OptimalApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Payments_OptimalApi : IPayments_OptimalApi
    {
        ...
        /// <returns></returns>
        public Payments_OptimalApi(Configuration configuration = null)
        {
