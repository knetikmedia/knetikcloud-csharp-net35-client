...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface ITemplates_PropertiesApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Templates_PropertiesApi : ITemplates_PropertiesApi
    {
        ...
        /// <returns></returns>
        public Templates_PropertiesApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< PropertyFieldListResource > GetTemplatePropertyTypeWithHttpInfo (string type)
        {
            ...
            if (type == null)
                throw new ApiException(400, "Missing required parameter 'type' when calling Templates_PropertiesApi->GetTemplatePropertyType");
