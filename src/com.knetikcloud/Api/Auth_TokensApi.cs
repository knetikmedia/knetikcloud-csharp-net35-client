...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IAuth_TokensApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Auth_TokensApi : IAuth_TokensApi
    {
        ...
        /// <returns></returns>
        public Auth_TokensApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< OauthAccessTokenResource > GetTokenWithHttpInfo (string username, string clientId)
        {
            ...
            if (username == null)
                throw new ApiException(400, "Missing required parameter 'username' when calling Auth_TokensApi->GetToken");
            // verify the required parameter 'clientId' is set
            if (clientId == null)
                throw new ApiException(400, "Missing required parameter 'clientId' when calling Auth_TokensApi->GetToken");
