...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IPayments_XsollaApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Payments_XsollaApi : IPayments_XsollaApi
    {
        ...
        /// <returns></returns>
        public Payments_XsollaApi(Configuration configuration = null)
        {
