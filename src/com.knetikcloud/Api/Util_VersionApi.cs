...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IUtil_VersionApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Util_VersionApi : IUtil_VersionApi
    {
        ...
        /// <returns></returns>
        public Util_VersionApi(Configuration configuration = null)
        {
