...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IUsers_RelationshipsApi : IApiAccessor
    {
        ...
        ApiResponse<PageResourceUserRelationshipResource> GetUserRelationshipsWithHttpInfo (int? size = null, int? page = null, string order = null);
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Users_RelationshipsApi : IUsers_RelationshipsApi
    {
        ...
        /// <returns></returns>
        public Users_RelationshipsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteUserRelationshipWithHttpInfo (long? id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Users_RelationshipsApi->DeleteUserRelationship");
        ...
        public ApiResponse< UserRelationshipResource > GetUserRelationshipWithHttpInfo (long? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Users_RelationshipsApi->GetUserRelationship");
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional)</param>
        /// <returns>PageResourceUserRelationshipResource</returns>
        public PageResourceUserRelationshipResource GetUserRelationships (int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageResourceUserRelationshipResource> localVarResponse = GetUserRelationshipsWithHttpInfo(size, page, order);
             return localVarResponse.Data;
        }
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional)</param>
        /// <returns>ApiResponse of PageResourceUserRelationshipResource</returns>
        public ApiResponse< PageResourceUserRelationshipResource > GetUserRelationshipsWithHttpInfo (int? size = null, int? page = null, string order = null)
        {
