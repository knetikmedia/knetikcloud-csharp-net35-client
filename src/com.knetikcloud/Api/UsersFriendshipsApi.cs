...
namespace com.knetikcloud.Api
{
    ...
    public interface IUsersFriendshipsApi : IApiAccessor
    {
        ...
        ApiResponse<PageResourceSimpleUserResource> GetFriendsWithHttpInfo (string userId, int? size = null, int? page = null);
        /// <summary>
    ...
    public partial class UsersFriendshipsApi : IUsersFriendshipsApi
    {
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>PageResourceSimpleUserResource</returns>
        public PageResourceSimpleUserResource GetFriends (string userId, int? size = null, int? page = null)
        {
             ApiResponse<PageResourceSimpleUserResource> localVarResponse = GetFriendsWithHttpInfo(userId, size, page);
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>ApiResponse of PageResourceSimpleUserResource</returns>
        public ApiResponse< PageResourceSimpleUserResource > GetFriendsWithHttpInfo (string userId, int? size = null, int? page = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
