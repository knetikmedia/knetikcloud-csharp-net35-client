...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IAuth_RolesApi : IApiAccessor
    {
        ...
        /// <param name="filterRole">Filter for roles that have a role starting with specified string (optional)</param>
        ...
        ApiResponse<PageResourceRoleResource> GetRolesWithHttpInfo (string filterName = null, string filterRole = null, int? size = null, int? page = null, string order = null);
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Auth_RolesApi : IAuth_RolesApi
    {
        ...
        /// <returns></returns>
        public Auth_RolesApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteRoleWithHttpInfo (string role, bool? force = null)
        {
            ...
            if (role == null)
                throw new ApiException(400, "Missing required parameter 'role' when calling Auth_RolesApi->DeleteRole");
        ...
        public ApiResponse< List<RoleResource> > GetClientRolesWithHttpInfo (string clientKey)
        {
            ...
            if (clientKey == null)
                throw new ApiException(400, "Missing required parameter 'clientKey' when calling Auth_RolesApi->GetClientRoles");
        ...
        public ApiResponse< RoleResource > GetRoleWithHttpInfo (string role)
        {
            // verify the required parameter 'role' is set
            if (role == null)
                throw new ApiException(400, "Missing required parameter 'role' when calling Auth_RolesApi->GetRole");
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional)</param>
        /// <returns>PageResourceRoleResource</returns>
        public PageResourceRoleResource GetRoles (string filterName = null, string filterRole = null, int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageResourceRoleResource> localVarResponse = GetRolesWithHttpInfo(filterName, filterRole, size, page, order);
             return localVarResponse.Data;
        }
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional)</param>
        /// <returns>ApiResponse of PageResourceRoleResource</returns>
        public ApiResponse< PageResourceRoleResource > GetRolesWithHttpInfo (string filterName = null, string filterRole = null, int? size = null, int? page = null, string order = null)
        {
        ...
        public ApiResponse< List<RoleResource> > GetUserRolesWithHttpInfo (int? userId)
        {
            ...
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling Auth_RolesApi->GetUserRoles");
        ...
        public ApiResponse< ClientResource > SetClientRolesWithHttpInfo (string clientKey, List<string> rolesList = null)
        {
            // verify the required parameter 'clientKey' is set
            if (clientKey == null)
                throw new ApiException(400, "Missing required parameter 'clientKey' when calling Auth_RolesApi->SetClientRoles");
        ...
        public ApiResponse< RoleResource > SetPermissionsForRoleWithHttpInfo (string role, List<string> permissionsList = null)
        {
            // verify the required parameter 'role' is set
            if (role == null)
                throw new ApiException(400, "Missing required parameter 'role' when calling Auth_RolesApi->SetPermissionsForRole");
        ...
        public ApiResponse< UserResource > SetUserRolesWithHttpInfo (int? userId, List<string> rolesList = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling Auth_RolesApi->SetUserRoles");
        ...
        public ApiResponse< RoleResource > UpdateRoleWithHttpInfo (string role, RoleResource roleResource = null)
        {
            // verify the required parameter 'role' is set
            if (role == null)
                throw new ApiException(400, "Missing required parameter 'role' when calling Auth_RolesApi->UpdateRole");
