...
namespace com.knetikcloud.Api
{
    ...
    public interface IMediaModerationApi : IApiAccessor
    {
        ...
        ApiResponse<PageResourceFlagReportResource> GetModerationReportsWithHttpInfo (bool? excludeResolved = null, string filterContext = null, string filterContextId = null, int? size = null, int? page = null);
        /// <summary>
    ...
    public partial class MediaModerationApi : IMediaModerationApi
    {
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>PageResourceFlagReportResource</returns>
        public PageResourceFlagReportResource GetModerationReports (bool? excludeResolved = null, string filterContext = null, string filterContextId = null, int? size = null, int? page = null)
        {
             ApiResponse<PageResourceFlagReportResource> localVarResponse = GetModerationReportsWithHttpInfo(excludeResolved, filterContext, filterContextId, size, page);
             return localVarResponse.Data;
        }
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>ApiResponse of PageResourceFlagReportResource</returns>
        public ApiResponse< PageResourceFlagReportResource > GetModerationReportsWithHttpInfo (bool? excludeResolved = null, string filterContext = null, string filterContextId = null, int? size = null, int? page = null)
        {
