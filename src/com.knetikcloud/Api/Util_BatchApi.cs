...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IUtil_BatchApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Util_BatchApi : IUtil_BatchApi
    {
        ...
        /// <returns></returns>
        public Util_BatchApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< List<BatchReturn> > GetBatchWithHttpInfo (string token)
        {
            ...
            if (token == null)
                throw new ApiException(400, "Missing required parameter 'token' when calling Util_BatchApi->GetBatch");
