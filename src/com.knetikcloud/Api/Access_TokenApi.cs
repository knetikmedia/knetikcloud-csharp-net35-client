...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IAccess_TokenApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Access_TokenApi : IAccess_TokenApi
    {
        ...
        /// <returns></returns>
        public Access_TokenApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< OAuth2Resource > GetOAuthTokenWithHttpInfo (string grantType, string clientId, string clientSecret = null, string username = null, string password = null, string token = null, string refreshToken = null)
        {
            ...
            if (grantType == null)
                throw new ApiException(400, "Missing required parameter 'grantType' when calling Access_TokenApi->GetOAuthToken");
            // verify the required parameter 'clientId' is set
            if (clientId == null)
                throw new ApiException(400, "Missing required parameter 'clientId' when calling Access_TokenApi->GetOAuthToken");
