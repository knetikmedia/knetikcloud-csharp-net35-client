...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IStore_ShippingApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Store_ShippingApi : IStore_ShippingApi
    {
        ...
        /// <returns></returns>
        public Store_ShippingApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteShippingItemWithHttpInfo (int? id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_ShippingApi->DeleteShippingItem");
        ...
        public ApiResponse<Object> DeleteShippingTemplateWithHttpInfo (string id, string cascade = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_ShippingApi->DeleteShippingTemplate");
        ...
        public ApiResponse< ShippingItem > GetShippingItemWithHttpInfo (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_ShippingApi->GetShippingItem");
        ...
        public ApiResponse< ItemTemplateResource > GetShippingTemplateWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_ShippingApi->GetShippingTemplate");
        ...
        public ApiResponse< ShippingItem > UpdateShippingItemWithHttpInfo (int? id, bool? cascade = null, ShippingItem shippingItem = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_ShippingApi->UpdateShippingItem");
        ...
        public ApiResponse< ItemTemplateResource > UpdateShippingTemplateWithHttpInfo (string id, ItemTemplateResource shippingTemplateResource = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_ShippingApi->UpdateShippingTemplate");
