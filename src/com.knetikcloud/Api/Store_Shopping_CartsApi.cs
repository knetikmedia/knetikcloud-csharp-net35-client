...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IStore_Shopping_CartsApi : IApiAccessor
    {
        ...
        /// <param name="currencyCode">The code of the currency (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> SetCartCurrencyWithHttpInfo (string id, StringWrapper currencyCode = null);
        /// <summary>
        ...
        /// <param name="userId">The id of the user (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> SetCartOwnerWithHttpInfo (string id, IntWrapper userId = null);
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Store_Shopping_CartsApi : IStore_Shopping_CartsApi
    {
        ...
        /// <returns></returns>
        public Store_Shopping_CartsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> AddCustomDiscountWithHttpInfo (string id, CouponDefinition customDiscount = null)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_Shopping_CartsApi->AddCustomDiscount");
        ...
        public ApiResponse<Object> AddDiscountToCartWithHttpInfo (string id, SkuRequest skuRequest = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_Shopping_CartsApi->AddDiscountToCart");
        ...
        public ApiResponse<Object> AddItemToCartWithHttpInfo (string id, CartItemRequest cartItemRequest = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_Shopping_CartsApi->AddItemToCart");
        ...
        public ApiResponse< string > CreateCartWithHttpInfo (int? owner = null, string currencyCode = null)
        {
            ...
            if (currencyCode != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "currency_code", currencyCode)); // query parameter
        ...
        public ApiResponse< Cart > GetCartWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_Shopping_CartsApi->GetCart");
        ...
        public ApiResponse< PageResourceCartSummary > GetCartsWithHttpInfo (int? filterOwnerId = null, int? size = null, int? page = null, string order = null)
        {
            ...
            if (filterOwnerId != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "filter_owner_id", filterOwnerId)); // query parameter
        ...
        public ApiResponse< CartShippableResponse > GetShippableWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_Shopping_CartsApi->GetShippable");
        ...
        public ApiResponse< SampleCountriesResponse > GetShippingCountriesWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_Shopping_CartsApi->GetShippingCountries");
        ...
        public ApiResponse<Object> RemoveDiscountFromCartWithHttpInfo (string id, string code)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_Shopping_CartsApi->RemoveDiscountFromCart");
            // verify the required parameter 'code' is set
            if (code == null)
                throw new ApiException(400, "Missing required parameter 'code' when calling Store_Shopping_CartsApi->RemoveDiscountFromCart");
        ...
        /// <param name="currencyCode">The code of the currency (optional)</param>
        /// <returns></returns>
        public void SetCartCurrency (string id, StringWrapper currencyCode = null)
        {
        ...
        /// <param name="currencyCode">The code of the currency (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> SetCartCurrencyWithHttpInfo (string id, StringWrapper currencyCode = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_Shopping_CartsApi->SetCartCurrency");
        ...
        /// <param name="userId">The id of the user (optional)</param>
        /// <returns></returns>
        public void SetCartOwner (string id, IntWrapper userId = null)
        {
        ...
        /// <param name="userId">The id of the user (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> SetCartOwnerWithHttpInfo (string id, IntWrapper userId = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_Shopping_CartsApi->SetCartOwner");
        ...
        public ApiResponse<Object> UpdateItemInCartWithHttpInfo (string id, CartItemRequest cartItemRequest = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_Shopping_CartsApi->UpdateItemInCart");
        ...
        public ApiResponse<Object> UpdateShippingAddressWithHttpInfo (string id, CartShippingAddressRequest cartShippingAddressRequest = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_Shopping_CartsApi->UpdateShippingAddress");
