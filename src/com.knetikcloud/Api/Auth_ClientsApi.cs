...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IAuth_ClientsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Auth_ClientsApi : IAuth_ClientsApi
    {
        ...
        /// <returns></returns>
        public Auth_ClientsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteClientWithHttpInfo (string clientKey)
        {
            ...
            if (clientKey == null)
                throw new ApiException(400, "Missing required parameter 'clientKey' when calling Auth_ClientsApi->DeleteClient");
        ...
        public ApiResponse< ClientResource > GetClientWithHttpInfo (string clientKey)
        {
            // verify the required parameter 'clientKey' is set
            if (clientKey == null)
                throw new ApiException(400, "Missing required parameter 'clientKey' when calling Auth_ClientsApi->GetClient");
        ...
        public ApiResponse<Object> SetClientGrantTypesWithHttpInfo (string clientKey, List<string> grantList = null)
        {
            // verify the required parameter 'clientKey' is set
            if (clientKey == null)
                throw new ApiException(400, "Missing required parameter 'clientKey' when calling Auth_ClientsApi->SetClientGrantTypes");
        ...
        public ApiResponse<Object> SetClientRedirectUrisWithHttpInfo (string clientKey, List<string> redirectList = null)
        {
            // verify the required parameter 'clientKey' is set
            if (clientKey == null)
                throw new ApiException(400, "Missing required parameter 'clientKey' when calling Auth_ClientsApi->SetClientRedirectUris");
        ...
        public ApiResponse< ClientResource > UpdateClientWithHttpInfo (string clientKey, ClientResource clientResource = null)
        {
            // verify the required parameter 'clientKey' is set
            if (clientKey == null)
                throw new ApiException(400, "Missing required parameter 'clientKey' when calling Auth_ClientsApi->UpdateClient");
