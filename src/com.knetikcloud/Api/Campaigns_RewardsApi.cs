...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface ICampaigns_RewardsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Campaigns_RewardsApi : ICampaigns_RewardsApi
    {
        ...
        /// <returns></returns>
        public Campaigns_RewardsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteRewardSetWithHttpInfo (int? id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Campaigns_RewardsApi->DeleteRewardSet");
        ...
        public ApiResponse< RewardSetResource > GetRewardSetWithHttpInfo (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Campaigns_RewardsApi->GetRewardSet");
