...
namespace com.knetikcloud.Api
{
    ...
    public interface IGamificationLevelingApi : IApiAccessor
    {
        ...
        ApiResponse<PageResourceUserLevelingResource> GetUserLevelsWithHttpInfo (int? userId, string filterName = null, int? size = null, int? page = null, string order = null);
        /// <summary>
    ...
    public partial class GamificationLevelingApi : IGamificationLevelingApi
    {
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional)</param>
        /// <returns>PageResourceUserLevelingResource</returns>
        public PageResourceUserLevelingResource GetUserLevels (int? userId, string filterName = null, int? size = null, int? page = null, string order = null)
        {
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional)</param>
        /// <returns>ApiResponse of PageResourceUserLevelingResource</returns>
        public ApiResponse< PageResourceUserLevelingResource > GetUserLevelsWithHttpInfo (int? userId, string filterName = null, int? size = null, int? page = null, string order = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
        ...
        public ApiResponse<Object> IncrementProgressWithHttpInfo (int? userId, string name, IntWrapper progress = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling GamificationLevelingApi->IncrementProgress");
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling GamificationLevelingApi->IncrementProgress");
        ...
        public ApiResponse<Object> SetProgressWithHttpInfo (int? userId, string name, IntWrapper progress = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling GamificationLevelingApi->SetProgress");
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling GamificationLevelingApi->SetProgress");
