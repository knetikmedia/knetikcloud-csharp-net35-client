...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IStore_BundlesApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Store_BundlesApi : IStore_BundlesApi
    {
        ...
        /// <returns></returns>
        public Store_BundlesApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteBundleItemWithHttpInfo (int? id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_BundlesApi->DeleteBundleItem");
        ...
        public ApiResponse<Object> DeleteBundleTemplateWithHttpInfo (string id, string cascade = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_BundlesApi->DeleteBundleTemplate");
        ...
        public ApiResponse< BundleItem > GetBundleItemWithHttpInfo (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_BundlesApi->GetBundleItem");
        ...
        public ApiResponse< ItemTemplateResource > GetBundleTemplateWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_BundlesApi->GetBundleTemplate");
        ...
        public ApiResponse< BundleItem > UpdateBundleItemWithHttpInfo (int? id, bool? cascade = null, BundleItem bundleItem = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_BundlesApi->UpdateBundleItem");
        ...
        public ApiResponse< ItemTemplateResource > UpdateBundleTemplateWithHttpInfo (string id, ItemTemplateResource bundleTemplateResource = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_BundlesApi->UpdateBundleTemplate");
