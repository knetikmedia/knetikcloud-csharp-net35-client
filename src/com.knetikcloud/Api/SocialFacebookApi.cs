...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface ISocialFacebookApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SocialFacebookApi : ISocialFacebookApi
    {
        ...
        /// <returns></returns>
        public SocialFacebookApi(Configuration configuration = null)
        {
