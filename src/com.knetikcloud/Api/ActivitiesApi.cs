...
namespace com.knetikcloud.Api
{
    ...
    public interface IActivitiesApi : IApiAccessor
    {
        ...
        /// <param name="activityOccurrenceResource">The activity occurrence object (optional)</param>
        /// <returns>ApiResponse of ActivityOccurrenceResource</returns>
        ApiResponse<ActivityOccurrenceResource> CreateActivityOccurrenceWithHttpInfo (bool? test = null, CreateActivityOccurrenceRequest activityOccurrenceResource = null);
        /// <summary>
        ...
        /// <param name="activityOccurrenceId">The id of the activity occurrence</param>
        /// <returns>ApiResponse of ActivityOccurrenceResource</returns>
        ApiResponse<ActivityOccurrenceResource> GetActivityOccurrenceDetailsWithHttpInfo (long? activityOccurrenceId);
        /// <summary>
    ...
    public partial class ActivitiesApi : IActivitiesApi
    {
        ...
        /// <param name="activityOccurrenceResource">The activity occurrence object (optional)</param>
        /// <returns>ActivityOccurrenceResource</returns>
        public ActivityOccurrenceResource CreateActivityOccurrence (bool? test = null, CreateActivityOccurrenceRequest activityOccurrenceResource = null)
        {
        ...
        /// <param name="activityOccurrenceResource">The activity occurrence object (optional)</param>
        /// <returns>ApiResponse of ActivityOccurrenceResource</returns>
        public ApiResponse< ActivityOccurrenceResource > CreateActivityOccurrenceWithHttpInfo (bool? test = null, CreateActivityOccurrenceRequest activityOccurrenceResource = null)
        {
        ...
        {
             ApiResponse<ActivityOccurrenceResource> localVarResponse = GetActivityOccurrenceDetailsWithHttpInfo(activityOccurrenceId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="activityOccurrenceId">The id of the activity occurrence</param>
        /// <returns>ApiResponse of ActivityOccurrenceResource</returns>
        public ApiResponse< ActivityOccurrenceResource > GetActivityOccurrenceDetailsWithHttpInfo (long? activityOccurrenceId)
        {
            // verify the required parameter 'activityOccurrenceId' is set
            if (activityOccurrenceId == null)
                throw new ApiException(400, "Missing required parameter 'activityOccurrenceId' when calling ActivitiesApi->GetActivityOccurrenceDetails");

            var localVarPath = "/activity-occurrences/{activity_occurrence_id}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetActivityOccurrenceDetails", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>PageResourceActivityOccurrenceResource</returns>
        public PageResourceActivityOccurrenceResource ListActivityOccurrences (string filterActivity = null, string filterStatus = null, int? filterEvent = null, int? filterChallenge = null, int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageResourceActivityOccurrenceResource> localVarResponse = ListActivityOccurrencesWithHttpInfo(filterActivity, filterStatus, filterEvent, filterChallenge, size, page, order);
             return localVarResponse.Data;
        }
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>ApiResponse of PageResourceActivityOccurrenceResource</returns>
        public ApiResponse< PageResourceActivityOccurrenceResource > ListActivityOccurrencesWithHttpInfo (string filterActivity = null, string filterStatus = null, int? filterEvent = null, int? filterChallenge = null, int? size = null, int? page = null, string order = null)
        {
            ...
            if (filterActivity != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "filter_activity", filterActivity)); // query parameter
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ListActivityOccurrences", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<PageResourceActivityOccurrenceResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PageResourceActivityOccurrenceResource) Configuration.ApiClient.Deserialize(localVarResponse, typeof(PageResourceActivityOccurrenceResource)));
        }
        ...
        /// <param name="activityOccurrenceResults">The activity occurrence object (optional)</param>
        /// <returns>ActivityOccurrenceResults</returns>
        public ActivityOccurrenceResults SetActivityOccurrenceResults (long? activityOccurrenceId, ActivityOccurrenceResultsResource activityOccurrenceResults = null)
        {
        ...
        /// <param name="activityOccurrenceResults">The activity occurrence object (optional)</param>
        /// <returns>ApiResponse of ActivityOccurrenceResults</returns>
        public ApiResponse< ActivityOccurrenceResults > SetActivityOccurrenceResultsWithHttpInfo (long? activityOccurrenceId, ActivityOccurrenceResultsResource activityOccurrenceResults = null)
        {
            // verify the required parameter 'activityOccurrenceId' is set
            if (activityOccurrenceId == null)
        ...
        public ApiResponse<Object> UpdateActivityOccurrenceStatusWithHttpInfo (long? activityOccurrenceId, ActivityOccurrenceStatusWrapper activityOccurrenceStatus = null)
        {
            ...
            if (activityOccurrenceId != null) localVarPathParams.Add("activity_occurrence_id", Configuration.ApiClient.ParameterToString(activityOccurrenceId)); // path parameter
            if (activityOccurrenceStatus != null && activityOccurrenceStatus.GetType() != typeof(byte[]))
            {
                localVarPostBody = Configuration.ApiClient.Serialize(activityOccurrenceStatus); // http body (model) parameter
            }
            else
            {
                localVarPostBody = activityOccurrenceStatus; // byte array
            }
