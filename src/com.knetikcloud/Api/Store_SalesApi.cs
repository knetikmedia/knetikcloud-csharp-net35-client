...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IStore_SalesApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Store_SalesApi : IStore_SalesApi
    {
        ...
        /// <returns></returns>
        public Store_SalesApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteCatalogSaleWithHttpInfo (int? id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_SalesApi->DeleteCatalogSale");
        ...
        public ApiResponse< CatalogSale > GetCatalogSaleWithHttpInfo (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_SalesApi->GetCatalogSale");
        ...
        public ApiResponse< CatalogSale > UpdateCatalogSaleWithHttpInfo (int? id, CatalogSale catalogSale = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_SalesApi->UpdateCatalogSale");
