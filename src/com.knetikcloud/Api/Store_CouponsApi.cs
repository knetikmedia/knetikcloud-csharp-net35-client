...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IStore_CouponsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Store_CouponsApi : IStore_CouponsApi
    {
        ...
        /// <returns></returns>
        public Store_CouponsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteCouponItemWithHttpInfo (int? id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_CouponsApi->DeleteCouponItem");
        ...
        public ApiResponse<Object> DeleteCouponTemplateWithHttpInfo (string id, string cascade = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_CouponsApi->DeleteCouponTemplate");
        ...
        public ApiResponse< CouponItem > GetCouponItemWithHttpInfo (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_CouponsApi->GetCouponItem");
        ...
        public ApiResponse< CouponItem > GetCouponItemBySkuWithHttpInfo (string sku)
        {
            ...
            if (sku == null)
                throw new ApiException(400, "Missing required parameter 'sku' when calling Store_CouponsApi->GetCouponItemBySku");
        ...
        public ApiResponse< ItemTemplateResource > GetCouponTemplateWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_CouponsApi->GetCouponTemplate");
        ...
        public ApiResponse< CouponItem > UpdateCouponItemWithHttpInfo (int? id, bool? cascade = null, CouponItem couponItem = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_CouponsApi->UpdateCouponItem");
        ...
        public ApiResponse< ItemTemplateResource > UpdateCouponTemplateWithHttpInfo (string id, ItemTemplateResource couponTemplateResource = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_CouponsApi->UpdateCouponTemplate");
