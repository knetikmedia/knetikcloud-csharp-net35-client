...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IUsers_AddressesApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Users_AddressesApi : IUsers_AddressesApi
    {
        ...
        /// <returns></returns>
        public Users_AddressesApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< SavedAddressResource > CreateAddressWithHttpInfo (string userId, SavedAddressResource savedAddressResource = null)
        {
            ...
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling Users_AddressesApi->CreateAddress");
        ...
        public ApiResponse<Object> DeleteAddressWithHttpInfo (string userId, int? id)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling Users_AddressesApi->DeleteAddress");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Users_AddressesApi->DeleteAddress");
        ...
        public ApiResponse< SavedAddressResource > GetAddressWithHttpInfo (string userId, int? id)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling Users_AddressesApi->GetAddress");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Users_AddressesApi->GetAddress");
        ...
        public ApiResponse< PageResourceSavedAddressResource > GetAddressesWithHttpInfo (string userId, int? size = null, int? page = null, string order = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling Users_AddressesApi->GetAddresses");
        ...
        public ApiResponse< SavedAddressResource > UpdateAddressWithHttpInfo (string userId, int? id, SavedAddressResource savedAddressResource = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling Users_AddressesApi->UpdateAddress");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Users_AddressesApi->UpdateAddress");
