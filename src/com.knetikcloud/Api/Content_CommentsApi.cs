...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IContent_CommentsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Content_CommentsApi : IContent_CommentsApi
    {
        ...
        /// <returns></returns>
        public Content_CommentsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteCommentWithHttpInfo (long? id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Content_CommentsApi->DeleteComment");
        ...
        public ApiResponse< CommentResource > GetCommentWithHttpInfo (long? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Content_CommentsApi->GetComment");
        ...
        public ApiResponse< PageResourceCommentResource > GetCommentsWithHttpInfo (string context, int? contextId, int? size = null, int? page = null)
        {
            ...
            if (context == null)
                throw new ApiException(400, "Missing required parameter 'context' when calling Content_CommentsApi->GetComments");
            // verify the required parameter 'contextId' is set
            if (contextId == null)
                throw new ApiException(400, "Missing required parameter 'contextId' when calling Content_CommentsApi->GetComments");
        ...
        public ApiResponse<Object> UpdateCommentWithHttpInfo (long? id, StringWrapper content = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Content_CommentsApi->UpdateComment");
