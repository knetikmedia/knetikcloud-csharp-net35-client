...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IContent_ArticlesApi : IApiAccessor
    {
        ...
        /// <param name="template">The template (optional)</param>
        /// <returns>TemplateResource</returns>
        ...
        /// <param name="template">The template (optional)</param>
        /// <returns>ApiResponse of TemplateResource</returns>
        ApiResponse<TemplateResource> CreateTemplateWithHttpInfo (string typeHint, TemplateResource template = null);
        /// <summary>
        ...
        /// <param name="typeHint">The type for the resource this template applies to</param>
        /// <param name="id">The id of the template</param>
        /// <param name="cascade">How to cascade the delete (optional)</param>
        /// <returns></returns>
        ...
        /// <param name="cascade">How to cascade the delete (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> DeleteTemplateWithHttpInfo (string typeHint, string id, string cascade = null);
        /// <summary>
        ...
        /// <param name="filterTagExclusion">Filter for articles with none of a specified set of tags (separated by comma) (optional)</param>
        ...
        /// <param name="id">The id of the template</param>
        /// <returns>ApiResponse of TemplateResource</returns>
        ApiResponse<TemplateResource> GetTemplateWithHttpInfo (string typeHint, string id);
        /// <summary>
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>ApiResponse of PageResourceTemplateResource</returns>
        ApiResponse<PageResourceTemplateResource> GetTemplatesWithHttpInfo (string typeHint, int? size = null, int? page = null, string order = null);
        /// <summary>
        ...
        /// <param name="template">The template (optional)</param>
        /// <returns>ApiResponse of TemplateResource</returns>
        ApiResponse<TemplateResource> UpdateTemplateWithHttpInfo (string typeHint, string id, TemplateResource template = null);
        /// <summary>
        ...
        /// <exception cref="com.knetikcloud.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="typeHint">The type for the resource this template applies to</param>
        /// <param name="resource">The resource to validate (optional)</param>
        /// <returns></returns>
        ...
        /// <param name="resource">The resource to validate (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> ValidateWithHttpInfo (string typeHint, BasicTemplatedResource resource = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Content_ArticlesApi : IContent_ArticlesApi
    {
        ...
        /// <returns></returns>
        public Content_ArticlesApi(Configuration configuration = null)
        {
        ...
        /// <param name="template">The template (optional)</param>
        /// <returns>TemplateResource</returns>
        public TemplateResource CreateTemplate (string typeHint, TemplateResource template = null)
        {
             ApiResponse<TemplateResource> localVarResponse = CreateTemplateWithHttpInfo(typeHint, template);
             return localVarResponse.Data;
        }
        ...
        /// <param name="template">The template (optional)</param>
        /// <returns>ApiResponse of TemplateResource</returns>
        public ApiResponse< TemplateResource > CreateTemplateWithHttpInfo (string typeHint, TemplateResource template = null)
        {
            // verify the required parameter 'typeHint' is set
            if (typeHint == null)
                throw new ApiException(400, "Missing required parameter 'typeHint' when calling Content_ArticlesApi->CreateTemplate");

            var localVarPath = "/templates/{type_hint}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (typeHint != null) localVarPathParams.Add("type_hint", Configuration.ApiClient.ParameterToString(typeHint)); // path parameter
        ...
        public ApiResponse<Object> DeleteArticleWithHttpInfo (string id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Content_ArticlesApi->DeleteArticle");
        ...
        public ApiResponse<Object> DeleteArticleTemplateWithHttpInfo (string id, string cascade = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Content_ArticlesApi->DeleteArticleTemplate");
        ...
        /// <param name="cascade">How to cascade the delete (optional)</param>
        /// <returns></returns>
        public void DeleteTemplate (string typeHint, string id, string cascade = null)
        {
             DeleteTemplateWithHttpInfo(typeHint, id, cascade);
        }
        ...
        /// <param name="cascade">How to cascade the delete (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> DeleteTemplateWithHttpInfo (string typeHint, string id, string cascade = null)
        {
            // verify the required parameter 'typeHint' is set
            if (typeHint == null)
                throw new ApiException(400, "Missing required parameter 'typeHint' when calling Content_ArticlesApi->DeleteTemplate");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Content_ArticlesApi->DeleteTemplate");

            var localVarPath = "/templates/{type_hint}/{id}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (typeHint != null) localVarPathParams.Add("type_hint", Configuration.ApiClient.ParameterToString(typeHint)); // path parameter
            if (id != null) localVarPathParams.Add("id", Configuration.ApiClient.ParameterToString(id)); // path parameter
            if (cascade != null && cascade.GetType() != typeof(byte[]))
            {
                localVarPostBody = Configuration.ApiClient.Serialize(cascade); // http body (model) parameter
            }
            else
            {
                localVarPostBody = cascade; // byte array
            }
        ...
        public ApiResponse< ArticleResource > GetArticleWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Content_ArticlesApi->GetArticle");
        ...
        public ApiResponse< TemplateResource > GetArticleTemplateWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Content_ArticlesApi->GetArticleTemplate");
        ...
        public ApiResponse< PageResourceArticleResource > GetArticlesWithHttpInfo (bool? filterActiveOnly = null, string filterCategory = null, string filterTagset = null, string filterTagIntersection = null, string filterTagExclusion = null, string filterTitle = null, int? size = null, int? page = null, string order = null)
        {
            ...
            if (filterTitle != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "filter_title", filterTitle)); // query parameter
            if (size != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "size", size)); // query parameter
            if (page != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "page", page)); // query parameter
            if (order != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "order", order)); // query parameter
        ...
        {
             ApiResponse<TemplateResource> localVarResponse = GetTemplateWithHttpInfo(typeHint, id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the template</param>
        /// <returns>ApiResponse of TemplateResource</returns>
        public ApiResponse< TemplateResource > GetTemplateWithHttpInfo (string typeHint, string id)
        {
            // verify the required parameter 'typeHint' is set
            if (typeHint == null)
                throw new ApiException(400, "Missing required parameter 'typeHint' when calling Content_ArticlesApi->GetTemplate");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Content_ArticlesApi->GetTemplate");
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>PageResourceTemplateResource</returns>
        public PageResourceTemplateResource GetTemplates (string typeHint, int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageResourceTemplateResource> localVarResponse = GetTemplatesWithHttpInfo(typeHint, size, page, order);
             return localVarResponse.Data;
        }
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)</param>
        /// <returns>ApiResponse of PageResourceTemplateResource</returns>
        public ApiResponse< PageResourceTemplateResource > GetTemplatesWithHttpInfo (string typeHint, int? size = null, int? page = null, string order = null)
        {
            // verify the required parameter 'typeHint' is set
            if (typeHint == null)
                throw new ApiException(400, "Missing required parameter 'typeHint' when calling Content_ArticlesApi->GetTemplates");
        ...
        public ApiResponse< ArticleResource > UpdateArticleWithHttpInfo (string id, ArticleResource articleResource = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Content_ArticlesApi->UpdateArticle");
        ...
        public ApiResponse< TemplateResource > UpdateArticleTemplateWithHttpInfo (string id, TemplateResource articleTemplateResource = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Content_ArticlesApi->UpdateArticleTemplate");
        ...
        /// <param name="template">The template (optional)</param>
        /// <returns>TemplateResource</returns>
        public TemplateResource UpdateTemplate (string typeHint, string id, TemplateResource template = null)
        {
             ApiResponse<TemplateResource> localVarResponse = UpdateTemplateWithHttpInfo(typeHint, id, template);
             return localVarResponse.Data;
        }
        ...
        /// <param name="template">The template (optional)</param>
        /// <returns>ApiResponse of TemplateResource</returns>
        public ApiResponse< TemplateResource > UpdateTemplateWithHttpInfo (string typeHint, string id, TemplateResource template = null)
        {
            // verify the required parameter 'typeHint' is set
            if (typeHint == null)
                throw new ApiException(400, "Missing required parameter 'typeHint' when calling Content_ArticlesApi->UpdateTemplate");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Content_ArticlesApi->UpdateTemplate");
        ...
        /// <param name="resource">The resource to validate (optional)</param>
        /// <returns></returns>
        public void Validate (string typeHint, BasicTemplatedResource resource = null)
        {
             ValidateWithHttpInfo(typeHint, resource);
        }
        ...
        /// <param name="resource">The resource to validate (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> ValidateWithHttpInfo (string typeHint, BasicTemplatedResource resource = null)
        {
            // verify the required parameter 'typeHint' is set
            if (typeHint == null)
                throw new ApiException(400, "Missing required parameter 'typeHint' when calling Content_ArticlesApi->Validate");

            var localVarPath = "/templates/{type_hint}/validate";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (typeHint != null) localVarPathParams.Add("type_hint", Configuration.ApiClient.ParameterToString(typeHint)); // path parameter
            if (resource != null && resource.GetType() != typeof(byte[]))
            {
                localVarPostBody = Configuration.ApiClient.Serialize(resource); // http body (model) parameter
            }
            else
            {
                localVarPostBody = resource; // byte array
            }
