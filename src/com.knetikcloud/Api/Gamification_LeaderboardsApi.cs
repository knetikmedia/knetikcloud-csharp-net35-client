...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IGamification_LeaderboardsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Gamification_LeaderboardsApi : IGamification_LeaderboardsApi
    {
        ...
        /// <returns></returns>
        public Gamification_LeaderboardsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< LeaderboardResource > GetLeaderboardWithHttpInfo (string contextType, string contextId, int? size = null, int? page = null, string order = null)
        {
            ...
            if (contextType == null)
                throw new ApiException(400, "Missing required parameter 'contextType' when calling Gamification_LeaderboardsApi->GetLeaderboard");
            // verify the required parameter 'contextId' is set
            if (contextId == null)
                throw new ApiException(400, "Missing required parameter 'contextId' when calling Gamification_LeaderboardsApi->GetLeaderboard");
        ...
        public ApiResponse< LeaderboardEntryResource > GetLeaderboardRankWithHttpInfo (string contextType, string contextId, string id)
        {
            // verify the required parameter 'contextType' is set
            if (contextType == null)
                throw new ApiException(400, "Missing required parameter 'contextType' when calling Gamification_LeaderboardsApi->GetLeaderboardRank");
            // verify the required parameter 'contextId' is set
            if (contextId == null)
                throw new ApiException(400, "Missing required parameter 'contextId' when calling Gamification_LeaderboardsApi->GetLeaderboardRank");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Gamification_LeaderboardsApi->GetLeaderboardRank");
