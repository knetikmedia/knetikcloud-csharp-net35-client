...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IRule_Engine_TriggersApi : IApiAccessor
    {
        ...
        /// <param name="filterTags">Filter for triggers that have all of the given tags (comma separated list) (optional)</param>
        /// <param name="filterName">Filter for triggers that have names containing the given string (optional)</param>
        /// <param name="filterSearch">Filter for triggers containing the given words somewhere within name, description and tags (optional)</param>
        ...
        ApiResponse<PageResourceBreTriggerResource> GetBRETriggersWithHttpInfo (bool? filterSystem = null, string filterCategory = null, string filterTags = null, string filterName = null, string filterSearch = null, int? size = null, int? page = null);
        /// <summary>
        /// Update a trigger
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Rule_Engine_TriggersApi : IRule_Engine_TriggersApi
    {
        ...
        /// <returns></returns>
        public Rule_Engine_TriggersApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteBRETriggerWithHttpInfo (string eventName)
        {
            ...
            if (eventName == null)
                throw new ApiException(400, "Missing required parameter 'eventName' when calling Rule_Engine_TriggersApi->DeleteBRETrigger");
        ...
        public ApiResponse< BreTriggerResource > GetBRETriggerWithHttpInfo (string eventName)
        {
            // verify the required parameter 'eventName' is set
            if (eventName == null)
                throw new ApiException(400, "Missing required parameter 'eventName' when calling Rule_Engine_TriggersApi->GetBRETrigger");
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>PageResourceBreTriggerResource</returns>
        public PageResourceBreTriggerResource GetBRETriggers (bool? filterSystem = null, string filterCategory = null, string filterTags = null, string filterName = null, string filterSearch = null, int? size = null, int? page = null)
        {
             ApiResponse<PageResourceBreTriggerResource> localVarResponse = GetBRETriggersWithHttpInfo(filterSystem, filterCategory, filterTags, filterName, filterSearch, size, page);
             return localVarResponse.Data;
        }
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>ApiResponse of PageResourceBreTriggerResource</returns>
        public ApiResponse< PageResourceBreTriggerResource > GetBRETriggersWithHttpInfo (bool? filterSystem = null, string filterCategory = null, string filterTags = null, string filterName = null, string filterSearch = null, int? size = null, int? page = null)
        {
