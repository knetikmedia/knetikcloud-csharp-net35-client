...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IUsers_FriendshipsApi : IApiAccessor
    {
        ...
        /// <param name="filterUsername">Filter for friends with the given username (optional)</param>
        /// <param name="filterUserId">Filter for friends by user id (optional)</param>
        ...
        ApiResponse<PageResourceSimpleUserResource> GetFriendsWithHttpInfo (string userId, string filterUsername = null, int? filterUserId = null, int? size = null, int? page = null);
        /// <summary>
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>ApiResponse of PageResourceSimpleUserResource</returns>
        ApiResponse<PageResourceSimpleUserResource> GetInvitesWithHttpInfo (string userId, int? size = null, int? page = null);
        /// <summary>
        ...
        /// <param name="token">The invite token (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> RedeemFriendshipTokenWithHttpInfo (string userId, StringWrapper token = null);
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Users_FriendshipsApi : IUsers_FriendshipsApi
    {
        ...
        /// <returns></returns>
        public Users_FriendshipsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> AddFriendWithHttpInfo (string userId, int? id)
        {
            ...
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling Users_FriendshipsApi->AddFriend");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Users_FriendshipsApi->AddFriend");
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>PageResourceSimpleUserResource</returns>
        public PageResourceSimpleUserResource GetFriends (string userId, string filterUsername = null, int? filterUserId = null, int? size = null, int? page = null)
        {
             ApiResponse<PageResourceSimpleUserResource> localVarResponse = GetFriendsWithHttpInfo(userId, filterUsername, filterUserId, size, page);
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>ApiResponse of PageResourceSimpleUserResource</returns>
        public ApiResponse< PageResourceSimpleUserResource > GetFriendsWithHttpInfo (string userId, string filterUsername = null, int? filterUserId = null, int? size = null, int? page = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling Users_FriendshipsApi->GetFriends");
        ...
        public ApiResponse< string > GetInviteTokenWithHttpInfo (string userId)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling Users_FriendshipsApi->GetInviteToken");
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>PageResourceSimpleUserResource</returns>
        public PageResourceSimpleUserResource GetInvites (string userId, int? size = null, int? page = null)
        {
             ApiResponse<PageResourceSimpleUserResource> localVarResponse = GetInvitesWithHttpInfo(userId, size, page);
             return localVarResponse.Data;
        }
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>ApiResponse of PageResourceSimpleUserResource</returns>
        public ApiResponse< PageResourceSimpleUserResource > GetInvitesWithHttpInfo (string userId, int? size = null, int? page = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling Users_FriendshipsApi->GetInvites");
        ...
        /// <param name="token">The invite token (optional)</param>
        /// <returns></returns>
        public void RedeemFriendshipToken (string userId, StringWrapper token = null)
        {
        ...
        /// <param name="token">The invite token (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> RedeemFriendshipTokenWithHttpInfo (string userId, StringWrapper token = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling Users_FriendshipsApi->RedeemFriendshipToken");
        ...
        public ApiResponse<Object> RemoveOrDeclineFriendWithHttpInfo (string userId, int? id)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling Users_FriendshipsApi->RemoveOrDeclineFriend");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Users_FriendshipsApi->RemoveOrDeclineFriend");
