...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IRule_Engine_VariablesApi : IApiAccessor
    {
        ...
        /// <param name="filterName">Filter results by those with names starting with this string (optional)</param>
        ...
        /// <param name="size">The number of objects returned per page (optional, default to 25)</param>
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>ApiResponse of PageResourceSimpleReferenceResourceobject</returns>
        ApiResponse<PageResourceSimpleReferenceResourceobject> GetBREVariableValuesWithHttpInfo (string name, string filterName = null, int? size = null, int? page = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Rule_Engine_VariablesApi : IRule_Engine_VariablesApi
    {
        ...
        /// <returns></returns>
        public Rule_Engine_VariablesApi(Configuration configuration = null)
        {
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>PageResourceSimpleReferenceResourceobject</returns>
        public PageResourceSimpleReferenceResourceobject GetBREVariableValues (string name, string filterName = null, int? size = null, int? page = null)
        {
             ApiResponse<PageResourceSimpleReferenceResourceobject> localVarResponse = GetBREVariableValuesWithHttpInfo(name, filterName, size, page);
             return localVarResponse.Data;
        }
        ...
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        /// <returns>ApiResponse of PageResourceSimpleReferenceResourceobject</returns>
        public ApiResponse< PageResourceSimpleReferenceResourceobject > GetBREVariableValuesWithHttpInfo (string name, string filterName = null, int? size = null, int? page = null)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling Rule_Engine_VariablesApi->GetBREVariableValues");

            var localVarPath = "/bre/variable-types/{name}/values";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetBREVariableValues", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<PageResourceSimpleReferenceResourceobject>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PageResourceSimpleReferenceResourceobject) Configuration.ApiClient.Deserialize(localVarResponse, typeof(PageResourceSimpleReferenceResourceobject)));
        }
