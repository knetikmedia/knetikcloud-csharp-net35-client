...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IPayments_TransactionsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Payments_TransactionsApi : IPayments_TransactionsApi
    {
        ...
        /// <returns></returns>
        public Payments_TransactionsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< TransactionResource > GetTransactionWithHttpInfo (int? id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Payments_TransactionsApi->GetTransaction");
        ...
        public ApiResponse< RefundResource > RefundTransactionWithHttpInfo (int? id, RefundRequest request = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Payments_TransactionsApi->RefundTransaction");
