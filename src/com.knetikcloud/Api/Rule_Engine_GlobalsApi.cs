...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IRule_Engine_GlobalsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Rule_Engine_GlobalsApi : IRule_Engine_GlobalsApi
    {
        ...
        /// <returns></returns>
        public Rule_Engine_GlobalsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteBREGlobalWithHttpInfo (string id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Rule_Engine_GlobalsApi->DeleteBREGlobal");
        ...
        public ApiResponse< BreGlobalResource > GetBREGlobalWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Rule_Engine_GlobalsApi->GetBREGlobal");
