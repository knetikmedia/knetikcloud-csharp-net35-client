...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IMedia_PollsApi : IApiAccessor
    {
        ...
        ApiResponse<PollResponseResource> AnswerPollWithHttpInfo (string id, StringWrapper answerKey = null);
        /// <summary>
        /// Create a new poll
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Media_PollsApi : IMedia_PollsApi
    {
        ...
        /// <returns></returns>
        public Media_PollsApi(Configuration configuration = null)
        {
        ...
        /// <param name="answerKey">The answer key (optional)</param>
        /// <returns>PollResponseResource</returns>
        public PollResponseResource AnswerPoll (string id, StringWrapper answerKey = null)
        {
        ...
        /// <param name="answerKey">The answer key (optional)</param>
        /// <returns>ApiResponse of PollResponseResource</returns>
        public ApiResponse< PollResponseResource > AnswerPollWithHttpInfo (string id, StringWrapper answerKey = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Media_PollsApi->AnswerPoll");
        ...
        public ApiResponse<Object> DeletePollWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Media_PollsApi->DeletePoll");
        ...
        public ApiResponse<Object> DeletePollTemplateWithHttpInfo (string id, string cascade = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Media_PollsApi->DeletePollTemplate");
        ...
        public ApiResponse< PollResource > GetPollWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Media_PollsApi->GetPoll");
        ...
        public ApiResponse< PollResponseResource > GetPollAnswerWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Media_PollsApi->GetPollAnswer");
        ...
        public ApiResponse< TemplateResource > GetPollTemplateWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Media_PollsApi->GetPollTemplate");
        ...
        public ApiResponse< PageResourcePollResource > GetPollsWithHttpInfo (string filterCategory = null, string filterTagset = null, string filterText = null, int? size = null, int? page = null, string order = null)
        {
            ...
            if (filterText != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "filter_text", filterText)); // query parameter
            if (size != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "size", size)); // query parameter
            if (page != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "page", page)); // query parameter
            if (order != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "order", order)); // query parameter
        ...
        public ApiResponse< PollResource > UpdatePollWithHttpInfo (string id, PollResource pollResource = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Media_PollsApi->UpdatePoll");
        ...
        public ApiResponse< TemplateResource > UpdatePollTemplateWithHttpInfo (string id, TemplateResource pollTemplateResource = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Media_PollsApi->UpdatePollTemplate");
