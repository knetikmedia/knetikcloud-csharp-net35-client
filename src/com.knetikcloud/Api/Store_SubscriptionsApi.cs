...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IStore_SubscriptionsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Store_SubscriptionsApi : IStore_SubscriptionsApi
    {
        ...
        /// <returns></returns>
        public Store_SubscriptionsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteSubscriptionWithHttpInfo (int? id, string planId)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_SubscriptionsApi->DeleteSubscription");
            // verify the required parameter 'planId' is set
            if (planId == null)
                throw new ApiException(400, "Missing required parameter 'planId' when calling Store_SubscriptionsApi->DeleteSubscription");
        ...
        public ApiResponse<Object> DeleteSubscriptionTemplateWithHttpInfo (string id, string cascade = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_SubscriptionsApi->DeleteSubscriptionTemplate");
        ...
        public ApiResponse< SubscriptionResource > GetSubscriptionWithHttpInfo (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_SubscriptionsApi->GetSubscription");
        ...
        public ApiResponse< SubscriptionTemplateResource > GetSubscriptionTemplateWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_SubscriptionsApi->GetSubscriptionTemplate");
        ...
        public ApiResponse<Object> UpdateSubscriptionWithHttpInfo (int? id, SubscriptionResource subscriptionResource = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_SubscriptionsApi->UpdateSubscription");
        ...
        public ApiResponse< SubscriptionTemplateResource > UpdateSubscriptionTemplateWithHttpInfo (string id, SubscriptionTemplateResource subscriptionTemplateResource = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Store_SubscriptionsApi->UpdateSubscriptionTemplate");
