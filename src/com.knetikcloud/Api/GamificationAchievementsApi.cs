...
namespace com.knetikcloud.Api
{
    ...
    public interface IGamificationAchievementsApi : IApiAccessor
    {
        ...
        /// <param name="progress">The amount to add to the progress value (optional)</param>
        /// <returns>ApiResponse of UserAchievementGroupResource</returns>
        ApiResponse<UserAchievementGroupResource> IncrementAchievementProgressWithHttpInfo (int? userId, string achievementName, int? progress = null);
        /// <summary>
        ...
        /// <param name="progress">The new progress value (optional)</param>
        /// <returns>ApiResponse of UserAchievementGroupResource</returns>
        ApiResponse<UserAchievementGroupResource> SetAchievementProgressWithHttpInfo (int? userId, string achievementName, int? progress = null);
        /// <summary>
    ...
    public partial class GamificationAchievementsApi : IGamificationAchievementsApi
    {
        ...
        /// <param name="progress">The amount to add to the progress value (optional)</param>
        /// <returns>UserAchievementGroupResource</returns>
        public UserAchievementGroupResource IncrementAchievementProgress (int? userId, string achievementName, int? progress = null)
        {
        ...
        /// <param name="progress">The amount to add to the progress value (optional)</param>
        /// <returns>ApiResponse of UserAchievementGroupResource</returns>
        public ApiResponse< UserAchievementGroupResource > IncrementAchievementProgressWithHttpInfo (int? userId, string achievementName, int? progress = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling GamificationAchievementsApi->IncrementAchievementProgress");
            // verify the required parameter 'achievementName' is set
            if (achievementName == null)
                throw new ApiException(400, "Missing required parameter 'achievementName' when calling GamificationAchievementsApi->IncrementAchievementProgress");
        ...
        /// <param name="progress">The new progress value (optional)</param>
        /// <returns>UserAchievementGroupResource</returns>
        public UserAchievementGroupResource SetAchievementProgress (int? userId, string achievementName, int? progress = null)
        {
        ...
        /// <param name="progress">The new progress value (optional)</param>
        /// <returns>ApiResponse of UserAchievementGroupResource</returns>
        public ApiResponse< UserAchievementGroupResource > SetAchievementProgressWithHttpInfo (int? userId, string achievementName, int? progress = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling GamificationAchievementsApi->SetAchievementProgress");
            // verify the required parameter 'achievementName' is set
            if (achievementName == null)
                throw new ApiException(400, "Missing required parameter 'achievementName' when calling GamificationAchievementsApi->SetAchievementProgress");
