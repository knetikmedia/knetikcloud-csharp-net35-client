...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IAuth_PermissionsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Auth_PermissionsApi : IAuth_PermissionsApi
    {
        ...
        /// <returns></returns>
        public Auth_PermissionsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeletePermissionWithHttpInfo (string permission, bool? force = null)
        {
            ...
            if (permission == null)
                throw new ApiException(400, "Missing required parameter 'permission' when calling Auth_PermissionsApi->DeletePermission");
        ...
        public ApiResponse< PermissionResource > GetPermissionWithHttpInfo (string permission)
        {
            // verify the required parameter 'permission' is set
            if (permission == null)
                throw new ApiException(400, "Missing required parameter 'permission' when calling Auth_PermissionsApi->GetPermission");
