...
namespace IO.Swagger.Api
{
    ...
    public interface IUsersGroupsApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="filterName">Filter for groups whose name starts with provided string (optional)</param>
        /// <param name="filterUniqueName">Filter for groups whose unique_name starts with provided string (optional)</param>
        /// <param name="filterParent">Filter for groups whose parent equals provided string (optional)</param>
        /// <param name="size">The number of objects returned per page (optional, default to 25)</param>
        /// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
        ...
        ApiResponse<PageResourceGroupResource> UpdateGroupsWithHttpInfo (string filterName = null, string filterUniqueName = null, string filterParent = null, int? size = null, int? page = null, string order = null);
    ...
    public partial class UsersGroupsApi : IUsersGroupsApi
    {
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>PageResourceGroupResource</returns>
        public PageResourceGroupResource UpdateGroups (string filterName = null, string filterUniqueName = null, string filterParent = null, int? size = null, int? page = null, string order = null)
        {
             ApiResponse<PageResourceGroupResource> localVarResponse = UpdateGroupsWithHttpInfo(filterName, filterUniqueName, filterParent, size, page, order);
             return localVarResponse.Data;
        }
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to name:ASC)</param>
        /// <returns>ApiResponse of PageResourceGroupResource</returns>
        public ApiResponse< PageResourceGroupResource > UpdateGroupsWithHttpInfo (string filterName = null, string filterUniqueName = null, string filterParent = null, int? size = null, int? page = null, string order = null)
        {
            ...
            if (filterUniqueName != null) localVarQueryParams.Add("filter_unique_name", Configuration.ApiClient.ParameterToString(filterUniqueName)); // query parameter
            if (filterParent != null) localVarQueryParams.Add("filter_parent", Configuration.ApiClient.ParameterToString(filterParent)); // query parameter
            if (size != null) localVarQueryParams.Add("size", Configuration.ApiClient.ParameterToString(size)); // query parameter
            if (page != null) localVarQueryParams.Add("page", Configuration.ApiClient.ParameterToString(page)); // query parameter
            if (order != null) localVarQueryParams.Add("order", Configuration.ApiClient.ParameterToString(order)); // query parameter
